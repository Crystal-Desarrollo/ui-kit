...
import { CircularProgress as za, Paper as ln, Modal as ts, IconButton as Jr, Typography as Ee, Divider as ro, Stack as Ge, Button as $r, Avatar as rs, TableHead as ns, TableRow as Yr, TableCell as Tr, TableSortLabel as os, FormControl as cn, InputLabel as Ra, Switch as as, TextField as Ia, Select as is, MenuItem as ss, createTheme as ls, ThemeProvider as no, TableContainer as Va, Table as Ha, TableBody as La, TablePagination as Fa, FormControlLabel as cs, Checkbox as us, Tab as ds, Slide as ps, Link as fs, Drawer as Za, useMediaQuery as ms, Toolbar as _r, AppBar as gs, Popper as hs, Grow as bs, ButtonBase as vs, Box as en, Container as ys } from "@mui/material";
import { Close as ws, Report as qa, Logout as Ds, Menu as As } from "@mui/icons-material";
import { useFormContext as Wr, Controller as zr } from "react-hook-form";
import { isValid as qn, isDate as Os, format as xs, formatRelative as Cs } from "date-fns";
import { useQuery as ka } from "@tanstack/react-query";
import { useNavigate as Ua, useSearchParams as Sa, Outlet as Qa, useLocation as Ms } from "react-router-dom";
import Nn from "qs";
import { ThemeContext as Ys, keyframes as oo } from "@emotion/react";
...
Check the top-level render call using <` + H + ">.");
    ...
    var Fr = St, mr = Lr;
    hr.Fragment = n, hr.jsx = Fr, hr.jsxs = mr;
  }()), hr;
}
process.env.NODE_ENV === "production" ? kn.exports = Gs() : kn.exports = Es();
var ao = kn.exports;
const ur = ao.Fragment, b = ao.jsx, ae = ao.jsxs, js = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  Fragment: ur,
  jsx: b,
  jsxs: ae
...
var Io;
function Ka() {
  return Io || (Io = 1, process.env.NODE_ENV === "production" ? Zr.exports = Ws() : Zr.exports = zs()), Zr.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Vs() {
  if (Zo)
    return jn;
  Zo = 1;
  var e = Ka(), t = Rs(), r = io(), n = Ja(), o = Is(), i = function() {
  };
    ...
    so,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ ae(Ge, { direction: "row", justifyContent: "end", children: [
          ...
          /* @__PURE__ */ b($r, { onClick: u, disabled: i, children: s ? "Reintentar" : "Confirmar" })
        ] })
      ]
    }
  );
...
const lo = (e) => {
  ...
  return /* @__PURE__ */ b(ns, { sx: { backgroundColor: (s) => s.palette.table.header }, children: /* @__PURE__ */ b(Yr, { children: n.map((s) => /* @__PURE__ */ b(Tr, { component: "th", children: s.isSortable ? /* @__PURE__ */ b(
    os,
    {
      active: t === s.id,
...
const Us = ({ defaultChecked: e = !1, name: t, labelText: r = "", ...n }) => {
  const o = Wa(), { control: i } = Wr();
  return /* @__PURE__ */ ae(cn, { style: { marginTop: "8px", marginLeft: "4px" }, ...n, children: [
    /* @__PURE__ */ b(
      Ra,
      {
        id: o,
      ...
      zr,
      {
        ...
        render: ({ field: s }) => /* @__PURE__ */ ae(
          Ge,
          {
            ...
            pl: 1,
            children: [
              /* @__PURE__ */ b(Ee, { variant: "caption", children: "No" }),
              /* @__PURE__ */ b(
                as,
                {
                  ref: s.ref,
              ...
              /* @__PURE__ */ b(Ee, { variant: "caption", children: "Si" })
            ]
          }
        )
      }
...
const Ks = ({ title: e, renderAside: t }) => /* @__PURE__ */ ae(
  Ge,
  {
    display: "flex",
    direction: "row",
...
const _a = ({
  ...
  const c = Wa(), u = i || Js, { control: d } = Wr(), f = (e == null ? void 0 : e.data) || e;
  ...
  return /* @__PURE__ */ ae(no, { theme: tn, children: [
    /* @__PURE__ */ b(Va, { children: /* @__PURE__ */ ae(Ha, { children: [
      ...
      /* @__PURE__ */ ae(La, { children: [
        ...
        (D == null ? void 0 : D.length) > 0 ? D.map((G) => ht.cloneElement(c, { key: G.id, data: G })) : /* @__PURE__ */ b(Yr, { children: /* @__PURE__ */ b(Tr, { colSpan: t.length, align: "center", children: /* @__PURE__ */ b(Ee, { variant: "h6", sx: { textAlign: "center" }, children: "No hay nada por aquí" }) }) })
      ] })
    ] }) }),
    /* @__PURE__ */ b(
      Fa,
    ...
    /* @__PURE__ */ ae(Va, { sx: { position: "relative", overflow: "visible" }, children: [
      ...
      /* @__PURE__ */ ae(Ha, { children: [
        ...
        /* @__PURE__ */ ae(La, { children: [
          ...
          !A && !h && ((G = g == null ? void 0 : g.data) == null ? void 0 : G.length) === 0 && /* @__PURE__ */ b(Yr, { children: /* @__PURE__ */ b(Tr, { colSpan: t.length, align: "center", children: /* @__PURE__ */ b(Ee, { variant: "h6", sx: { textAlign: "center" }, children: "No hay nada por aquí" }) }) })
        ] })
      ] })
    ] }),
    g && /* @__PURE__ */ b(
...
process.env.NODE_ENV === "production" ? Xn.exports = Kl() : Xn.exports = Jl();
var So = Xn.exports;
...
const tc = a.oneOfType([a.func, a.object]), co = tc;
function oe(e) {
  if (typeof e != "string")
...
function Pc(e) {
  ...
  const s = Tc(C({}, o, n)), l = _o(n), c = _o(o), u = t(s), d = xe(u == null ? void 0 : u.className, r == null ? void 0 : r.className, i, o == null ? void 0 : o.className, n == null ? void 0 : n.className), f = C({}, u == null ? void 0 : u.style, r == null ? void 0 : r.style, o == null ? void 0 : o.style, n == null ? void 0 : n.style), m = C({}, u, r, c, l);
...
var Je = "top", ct = "bottom", ut = "right", $e = "left", uo = "auto", Rr = [Je, ct, ut, $e], ir = "start", Br = "end", Ec = "clippingParents", pi = "viewport", yr = "popper", jc = "reference", ea = /* @__PURE__ */ Rr.reduce(function(e, t) {
...
function Ir(e) {
  for (var t = nt(e), r = ta(e); r && Qc(r) && Tt(r).position === "static"; )
    r = ta(r);
  return r && (At(r) === "html" || At(r) === "body" && Tt(r).position === "static") ? t : r || Xc(e) || t;
}
function mo(e) {
...
function $c(e) {
  ...
  if (!(!i || !s)) {
    var f = Jc(o.padding, r), m = fo(i), v = c === "y" ? Je : $e, A = c === "y" ? ct : ut, h = r.rects.reference[d] + r.rects.reference[c] - s[c] - r.rects.popper[d], g = s[c] - r.rects.reference[c], N = Ir(i), W = N ? c === "y" ? N.clientHeight || 0 : N.clientWidth || 0 : 0, j = h / 2 - g / 2, x = f[v], D = W - m[d] - f[A], G = W / 2 - m[d] / 2 + j, I = Or(x, G, D), R = c;
...
function ra(e) {
  ...
  if (u) {
    ...
    if (G === nt(r) && (G = Et(r), Tt(G).position !== "static" && l === "absolute" && (I = "scrollHeight", R = "scrollWidth")), G = G, o === Je || (o === $e || o === ut) && i === Br) {
      x = ct;
...
function oa(e, t, r) {
  return t === pi ? _n(cu(e, r)) : Lt(t) ? du(t, r) : _n(uu(Et(e)));
}
function pu(e) {
  var t = xr(dn(e)), r = ["absolute", "fixed"].indexOf(Tt(e).position) >= 0, n = r && lt(e) ? Ir(e) : e;
...
function Gr(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = n === void 0 ? e.placement : n, i = r.strategy, s = i === void 0 ? e.strategy : i, l = r.boundary, c = l === void 0 ? Ec : l, u = r.rootBoundary, d = u === void 0 ? pi : u, f = r.elementContext, m = f === void 0 ? yr : f, v = r.altBoundary, A = v === void 0 ? !1 : v, h = r.padding, g = h === void 0 ? 0 : h, N = bi(typeof g != "number" ? g : vi(g, Rr)), W = m === yr ? jc : yr, j = e.rects.popper, x = e.elements[A ? W : m], D = fu(Lt(x) ? x : x.contextElement || Et(e.elements.popper), c, d, s), G = lr(e.elements.reference), I = wi({
    reference: G,
    element: j,
    strategy: "absolute",
    placement: o
  }), R = _n(Object.assign({}, j, I)), V = m === yr ? R : G, P = {
...
function hu(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var o = r.mainAxis, i = o === void 0 ? !0 : o, s = r.altAxis, l = s === void 0 ? !0 : s, c = r.fallbackPlacements, u = r.padding, d = r.boundary, f = r.rootBoundary, m = r.altBoundary, v = r.flipVariations, A = v === void 0 ? !0 : v, h = r.allowedAutoPlacements, g = t.options.placement, N = Dt(g), W = N === g, j = c || (W || !A ? [Qr(g)] : gu(g)), x = [g].concat(j).reduce(function(Z, $) {
      return Z.concat(Dt($) === uo ? mu(t, {
        placement: $,
        boundary: d,
        rootBoundary: f,
        padding: u,
      ...
      var E = x[P], re = Dt(E), K = cr(E) === ir, ne = [Je, ct].indexOf(re) >= 0, se = ne ? "width" : "height", te = Gr(t, {
        placement: E,
        boundary: d,
        rootBoundary: f,
        altBoundary: m,
...
function Mu(e) {
  var t = e.state, r = e.options, n = e.name, o = r.mainAxis, i = o === void 0 ? !0 : o, s = r.altAxis, l = s === void 0 ? !1 : s, c = r.boundary, u = r.rootBoundary, d = r.altBoundary, f = r.padding, m = r.tether, v = m === void 0 ? !0 : m, A = r.tetherOffset, h = A === void 0 ? 0 : A, g = Gr(t, {
    ...
    padding: f,
    altBoundary: d
  }), N = Dt(t.placement), W = cr(t.placement), j = !W, x = mo(N), D = Cu(x), G = t.modifiersData.popperOffsets, I = t.rects.reference, R = t.rects.popper, V = typeof h == "function" ? h(Object.assign({}, t.rects, {
    placement: t.placement
  })) : h, P = typeof V == "number" ? {
    mainAxis: V,
    altAxis: V
  ...
  if (G) {
    if (i) {
      var K, ne = x === "y" ? Je : $e, se = x === "y" ? ct : ut, te = x === "y" ? "height" : "width", ce = G[x], le = ce + g[ne], pe = ce - g[se], M = v ? -R[te] / 2 : 0, L = W === ir ? I[te] : R[te], ee = W === ir ? -R[te] : -I[te], Q = t.elements.arrow, Z = v && Q ? fo(Q) : {
        width: 0,
        height: 0
      }, $ = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : hi(), X = $[ne], k = $[se], U = Or(0, I[te], Z[te]), _ = j ? I[te] / 2 - M - U - X - P.mainAxis : L - U - X - P.mainAxis, ie = j ? -I[te] / 2 + M + U + k + P.mainAxis : ee + U + k + P.mainAxis, fe = t.elements.arrow && Ir(t.elements.arrow), z = fe ? x === "y" ? fe.clientTop || 0 : fe.clientLeft || 0 : 0, Me = (K = E == null ? void 0 : E[x]) != null ? K : 0, F = ce + _ - Me - z, S = ce + ie - Me, We = Or(v ? nn(le, F) : le, ce, v ? Vt(pe, S) : pe);
      G[x] = We, re[x] = We - ce;
    }
    if (l) {
      var me, qe = x === "x" ? Je : $e, ze = x === "x" ? ct : ut, Re = G[D], He = D === "y" ? "height" : "width", Ie = Re + g[qe], pt = Re - g[ze], Se = [Je, $e].indexOf(N) !== -1, Ze = (me = E == null ? void 0 : E[D]) != null ? me : 0, ot = Se ? Ie : Re - I[He] - R[He] - Ze + P.altAxis, Ce = Se ? Re + I[He] + R[He] - Ze - P.altAxis : pt, Oe = v && Se ? Kc(ot, Re, Ce) : Or(v ? ot : Ie, Re, v ? Ce : pt);
      G[D] = Oe, re[D] = Oe - Re;
    }
...
function Bu(e, t, r) {
  r === void 0 && (r = !1);
  var n = lt(t), o = lt(t) && Pu(t), i = Et(t), s = lr(e, o, r), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  bo(i)) && (l = Nu(t)), lt(t) ? (c = lr(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : i && (c.x = ho(i))), {
    ...
    var d = {
      ...
      forceUpdate: function() {
        if (!m) {
          ...
          if (la(W, j)) {
            d.rects = {
              reference: Bu(W, Ir(j), d.options.strategy === "fixed"),
              popper: fo(j)
...
process.env.NODE_ENV !== "production" && (on["propTypes"] = Xl(on.propTypes));
function Hu(e) {
...
const ku = () => Nt({
  ...
  } = t, g = Te(t, Lu), N = Y.useRef(null), W = Yt(N, r), j = Y.useRef(null), x = Yt(j, m), D = Y.useRef(x);
  ar(() => {
    D.current = x;
  }, [x]), Y.useImperativeHandle(m, () => j.current, []);
  const G = Zu(d, s), [I, R] = Y.useState(G), [V, P] = Y.useState(an(o));
  Y.useEffect(() => {
...
`));
  ...
  const {
    ...
    slotProps: g = {},
    slots: N = {}
  } = t, W = Te(t, Fu), [j, x] = Y.useState(!0), D = () => {
    x(!1);
  }, G = () => {
    x(!0);
  };
...
function td(e) {
  const {
    ...
    unit: r = "px",
    step: n = 5
  } = e, o = Te(e, _u), i = ed(t), s = Object.keys(i);
  function l(m) {
...
bn(yn, wn, Dn, Md, Yd, Td, Nd, Pd, Bd, Gd, Ed, jd);
function tr(e, t) {
  return t === "grey" ? t : e;
}
const Wd = Ae({
...
const Ci = Sd();
Ci.filterProps = ["sx"];
const wo = Ci, Qd = ["breakpoints", "palette", "spacing", "shape"];
function Do(e = {}, ...t) {
  const {
    breakpoints: r = {},
    palette: n = {},
...
const sp = Do(), ma = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function wr({
  defaultTheme: e,
  theme: t,
  themeId: r
...
function cp(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, l = {}) => {
    ...
    let N = Xr;
    u === "Root" || u === "root" ? N = n : u ? N = o : np(s) && (N = void 0);
    const W = Ju(s, C({
      shouldForwardProp: N,
      label: g
    }, v)), j = (x, ...D) => {
      ...
      if (process.env.NODE_ENV !== "production") {
        let P;
        c && (P = `${c}${oe(u || "")}`), P === void 0 && (P = `Styled(${ec(s)})`), V.displayName = P;
      }
...
function Ep(e) {
  const {
    ...
    tonalOffset: n = 0.2
  } = e, o = Te(e, Mp), i = e.primary || Yp(t), s = e.secondary || Tp(t), l = e.error || Np(t), c = e.info || Pp(t), u = e.success || Bp(t), d = e.warning || Gp(t);
  function f(h) {
...
const $p = (e) => Xr(e) && e !== "classes", _p = cp({
  themeId: Oo,
  defaultTheme: xo,
...
}, Aa = ef, tf = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], rf = Ne(Di, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = Mi(), i = Ot({
    ...
    slots: j,
    slotProps: x
  } = i, D = Te(i, tf), G = (n = j == null ? void 0 : j.root) != null ? n : c == null ? void 0 : c.Root, I = C({
    anchorEl: s,
    container: d,
    disablePortal: f,
    keepMounted: m,
...
var bf = Object.values || function(e) {
  ...
  return r.componentDidMount = function() {
    ...
    var o = this.props, i = o.component, s = o.childFactory, l = Te(o, ["component", "childFactory"]), c = this.state.contextValue, u = bf(this.state.children).map(s);
...
const eo = 550, Af = 80, Of = oo(xa || (xa = xn`
  0% {
    transform: scale(0);
    opacity: 0.1;
  }
...
`), it.rippleVisible, Of, eo, ({
  theme: e
}) => e.transitions.easing.easeInOut, it.ripplePulsate, ({
  theme: e
}) => e.transitions.duration.shorter, it.child, it.childLeaving, xf, eo, ({
  theme: e
  ...
  const n = Ot({
    ...
    classes: i = {},
    className: s
  } = n, l = Te(n, Df), [c, u] = Y.useState([]), d = Y.useRef(0), f = Y.useRef(null);
  Y.useEffect(() => {
...
const Pf = _e("MuiButtonBase", ["root", "disabled", "focusVisible"]), Bf = Pf, Gf = ["action", "centerRipple", "children", "className", "component", "disabled", "disableRipple", "disableTouchRipple", "focusRipple", "focusVisibleClassName", "LinkComponent", "onBlur", "onClick", "onContextMenu", "onDragLeave", "onFocus", "onFocusVisible", "onKeyDown", "onKeyUp", "onMouseDown", "onMouseLeave", "onMouseUp", "onTouchEnd", "onTouchMove", "onTouchStart", "tabIndex", "TouchRippleProps", "touchRippleRef", "type"], Ef = (e) => {
  const {
    disabled: t,
    focusVisible: r,
  ...
  const n = Ot({
    ...
    touchRippleRef: ne,
    type: se
  } = n, te = Te(n, Gf), ce = Y.useRef(null), le = Y.useRef(null), pe = Yt(le, ne), {
    isFocusVisibleRef: M,
    onFocus: L,
    onBlur: ee,
    ref: Q
...
const Ff = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Zf = (e) => {
  ...
  const n = Ot({
    ...
    titleAccess: f,
    viewBox: m = "0 0 24 24"
  } = n, v = Te(n, Ff), A = /* @__PURE__ */ Y.isValidElement(o) && o.type === "svg", h = C({}, n, {
    color: s,
    component: l,
    fontSize: c,
...
const Vi = /* @__PURE__ */ Y.forwardRef(function(t, r) {
  ...
  } = n, D = Te(n, Qf), G = Y.useRef(null), I = Yt(G, r), R = (pe) => {
  ...
  })), process.env.NODE_ENV !== "production" && ce && le && console.error("MUI: The Chip component can not handle the avatar and the icon prop at the same time. Pick one."), /* @__PURE__ */ ae(Kf, C({
    as: re,
...
const $f = Vi, _f = _e("MuiInputBase", ["root", "formControl", "focused", "disabled", "adornedStart", "adornedEnd", "error", "sizeSmall", "multiline", "colorSecondary", "fullWidth", "hiddenLabel", "readOnly", "input", "inputSizeSmall", "inputMultiline", "inputTypeSearch", "inputAdornedStart", "inputAdornedEnd", "inputHiddenLabel"]), yt = _f, em = C({}, yt, _e("MuiInput", ["root", "underline", "input"])), Hn = em, tm = C({}, yt, _e("MuiOutlinedInput", ["root", "notchedOutline", "input"])), Pa = tm, rm = C({}, yt, _e("MuiFilledInput", ["root", "underline", "input"])), er = rm, nm = Cn(/* @__PURE__ */ b("path", {
...
const sm = ["autoComplete", "autoHighlight", "autoSelect", "blurOnSelect", "ChipProps", "className", "clearIcon", "clearOnBlur", "clearOnEscape", "clearText", "closeText", "componentsProps", "defaultValue", "disableClearable", "disableCloseOnSelect", "disabled", "disabledItemsFocusable", "disableListWrap", "disablePortal", "filterOptions", "filterSelectedOptions", "forcePopupIcon", "freeSolo", "fullWidth", "getLimitTagsText", "getOptionDisabled", "getOptionLabel", "isOptionEqualToValue", "groupBy", "handleHomeEndKeys", "id", "includeInputInList", "inputValue", "limitTags", "ListboxComponent", "ListboxProps", "loading", "loadingText", "multiple", "noOptionsText", "onChange", "onClose", "onHighlightChange", "onInputChange", "onOpen", "open", "openOnFocus", "openText", "options", "PaperComponent", "PopperComponent", "popupIcon", "readOnly", "renderGroup", "renderInput", "renderOption", "renderTags", "selectOnFocus", "size", "slotProps", "value"], lm = ["ref"], cm = (e) => {
  ...
  const l = Ot({
    ...
    ref: qt
  } = Bt, kt = Te(Bt, lm), fr = Yt(qt, Wt), Gt = te || ((O) => {
    var B;
  ...
  if ($ && J.length > 0) {
    ...
    We ? Ke = We(J, O, Ve) : Ke = J.map((B, q) => /* @__PURE__ */ b($f, C({
      label: Gt(B),
      size: qe
    }, O({
      index: q
...
const Dm = Hi, Am = Ai(), Om = (e) => {
  const {
    ...
    baseParams: c,
    ...u
  } = e, { control: d } = Wr(), [f, m] = st([]), [v, A] = st(l ? [] : ""), [h, g] = st(""), { isFetching: N, refetch: W, isFetched: j } = ka({
    queryKey: [s, h],
  ...
  const x = (R, V, P) => {
    ...
    const P = Am(R, V), E = String(V.inputValue).trim(), re = P.length === 0;
...
}, Symbol.toStringTag, { value: "Module" })), Tm = /* @__PURE__ */ Xa(Ym);
var Ea;
function Yn() {
...
const Tn = /* @__PURE__ */ Xa(js);
var Nm = Mn;
Object.defineProperty(No, "__esModule", {
  value: !0
});
var Fi = No.default = void 0, Pm = Nm(Yn()), Bm = Tn, Gm = (0, Pm.default)(/* @__PURE__ */ (0, Bm.jsx)("path", {
...
const xg = ({
  ...
  sx: t,
  ...r
}) => /* @__PURE__ */ b($r, { sx: { px: 1, py: 1, ...t }, ...r, children: e });
function Cg() {
  const [e, t] = Sa();
  return {
...
const Um = (e) => {
  ...
  const n = Ot({
    ...
    wrap: h = "wrap",
    zeroMinWidth: g = !1
  } = i, N = Te(i, Im), W = v || A, j = c || A, x = Y.useContext(ja), D = d ? l || 12 : x, G = {}, I = C({}, N);
  o.keys.forEach((P) => {
...
var Qi = Po.default = void 0, Jm = Km(Yn()), $m = Tn, _m = (0, Jm.default)(/* @__PURE__ */ (0, $m.jsx)("path", {
...
var Xi = Bo.default = void 0, tg = eg(Yn()), rg = Tn, ng = (0, tg.default)(/* @__PURE__ */ (0, rg.jsx)("path", {
...
var Ki = Go.default = void 0, ag = og(Yn()), ig = Tn, sg = (0, ag.default)(/* @__PURE__ */ (0, ig.jsx)("path", {
...
const Ji = ({ user: e, logout: t, onToggleDrawer: r, open: n }) => {
  ...
  return /* @__PURE__ */ ae(ur, { children: [
    ...
    /* @__PURE__ */ b(lg, { position: "absolute", open: n, children: /* @__PURE__ */ ae(_r, { sx: { position: "relative" }, children: [
      /* @__PURE__ */ b(
        Jr,
        {
          edge: "start",
