...
function Ls() {
  return Ro || (Ro = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function G(p, P, V) {
      {
        var w = N.ReactDebugCurrentFrame, D = w.getStackAddendum();
        D !== "" && (P += "%s", V = V.concat([D]));
    ...
    var C = !1, v = !1, B = !1, j = !1, R = !1, k;
    k = Symbol.for("react.module.reference");
    function T(p) {
      return !!(typeof p == "string" || typeof p == "function" || p === n || p === i || R || p === o || p === u || p === d || j || p === b || C || v || B || typeof p == "object" && p !== null && (p.$$typeof === m || p.$$typeof === f || p.$$typeof === s || p.$$typeof === l || p.$$typeof === c || // This needs to include all possible module reference object
      ...
      if (typeof p == "object")
        switch (p.$$typeof) {
          ...
          case f:
            ...
            return w !== null ? w : $(p.type) || "Memo";
          case m: {
            var D = p, O = D._payload, E = D._init;
            try {
              return $(E(O));
            } catch {
              return null;
    ...
    var ne = Object.assign, se = 0, re, ce, le, pe, Y, H, te;
    function Q() {
    }
    ...
    function F() {
      {
        if (se === 0) {
          re = console.log, ce = console.info, le = console.warn, pe = console.error, Y = console.group, H = console.groupCollapsed, te = console.groupEnd;
          var p = {
            configurable: !0,
            enumerable: !0,
            value: Q,
...
` + q + p;
    ...
    function z(p, P) {
      ...
      try {
        ...
        if (Ct && w && typeof Ct.stack == "string") {
          for (var Z = Ct.stack.split(`
`), ue = w.stack.split(`
...
` + Z[de].replace(" at new ", " at ");
        ...
        ee = !1, X.current = O, _(), Error.prepareStackTrace = D;
      }
      var St = p ? p.displayName || p.name : "", jo = St ? U(St) : "";
      ...
      if (typeof p == "object")
        switch (p.$$typeof) {
          ...
          case f:
            return S(p.type, P, V);
          case m: {
            var w = p, D = w._payload, O = w._init;
            try {
              return S(O(D), P, V);
            } catch {
            }
    ...
    function Re(p) {
      if (p) {
        var P = p._owner, V = S(p.type, p._source, P ? P.type : null);
        qe.setExtraStackFrame(V);
      } else
        qe.setExtraStackFrame(null);
    }
    function Ie(p, P, V, w, D) {
      {
          ...
          if (O(p, E)) {
            ...
            try {
              if (typeof p[E] != "function") {
                var ue = Error((w || "React class") + ": " + V + " type `" + E + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof p[E] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw ue.name = "Invariant Violation", ue;
              }
              Z = p[E](P, E, w, V, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (de) {
              Z = de;
            }
            Z && !(Z instanceof Error) && (Re(D), W("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", w || "React class", V, E, typeof Z), Re(null)), Z instanceof Error && !(Z.message in me) && (me[Z.message] = !0, Re(D), W("Failed %s type: %s", V, Z.message), Re(null));
          }
      }
    }
    ...
    function ft(p) {
      {
        var P = typeof Symbol == "function" && Symbol.toStringTag, V = P && p[Symbol.toStringTag] || p.constructor.name || "Object";
        return V;
      }
    }
    function Qe(p) {
    ...
    function Xe(p, P) {
      if (typeof p.ref == "string" && Me.current && P && Me.current.stateNode !== P) {
        var V = $(Me.current.type);
        at[V] || (W('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', $(Me.current.type), p.ref), at[V] = !0);
      }
    }
    function dr(p, P) {
      {
    ...
    function vt(p, P) {
      {
        var V = function() {
          mt || (mt = !0, W("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", P));
        };
    ...
    function gt(p, P, V, w, D) {
      {
        var O, E = {}, Z = null, ue = null;
        V !== void 0 && (ot(V), Z = "" + V), ke(P) && (ot(P.key), Z = "" + P.key), Pt(P) && (ue = P.ref, Xe(P, D));
        for (O in P)
          We.call(P, O) && !xe.hasOwnProperty(O) && (E[O] = P[O]);
        if (p && p.defaultProps) {
        ...
        if (Z || ue) {
          ...
          Z && dr(E, he), ue && vt(E, he);
        }
        return pr(p, Z, ue, D, w, Me.current, E);
      }
    }
    var Ke = N.ReactCurrentOwner, et = N.ReactDebugCurrentFrame;
    function Ue(p) {
      if (p) {
        var P = p._owner, V = S(p.type, p._source, P ? P.type : null);
...
Check the render method of \`` + p + "`.";
    ...
    function Zt(p) {
      {
        if (p !== void 0) {
          var P = p.fileName.replace(/^.*[\\\/]/, ""), V = p.lineNumber;
          return `
...
Check the top-level render call using <` + V + ">.");
    ...
    function kt(p, P) {
      {
        ...
        qt[V] = !0;
        var w = "";
        p && p._owner && p._owner !== Ke.current && (w = " It was passed a child from " + $(p._owner.type) + "."), Ue(p), W('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', V, w), Ue(null);
      }
    }
    function Et(p, P) {
      {
        ...
        if (Ve(p))
          ...
          if (typeof D == "function" && D !== p.entries)
            for (var O = D.call(p), E; !(E = O.next()).done; )
              Wt(E.value) && kt(E.value, P);
        }
      }
    }
    function He(p) {
    ...
    function je(p) {
      {
        for (var P = Object.keys(p.props), V = 0; V < P.length; V++) {
          var w = P[V];
          if (w !== "children" && w !== "key") {
            Ue(p), W("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", w), Ue(null);
            break;
          }
        }
...
var no = kn.exports;
const ur = no.Fragment, h = no.jsx, oe = no.jsxs, Fs = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  Fragment: ur,
  jsx: h,
  jsxs: oe
...
function Zs() {
  if (Io)
    return ve;
  Io = 1;
  var e = typeof Symbol == "function" && Symbol.for, t = e ? Symbol.for("react.element") : 60103, r = e ? Symbol.for("react.portal") : 60106, n = e ? Symbol.for("react.fragment") : 60107, o = e ? Symbol.for("react.strict_mode") : 60108, i = e ? Symbol.for("react.profiler") : 60114, s = e ? Symbol.for("react.provider") : 60109, l = e ? Symbol.for("react.context") : 60110, c = e ? Symbol.for("react.async_mode") : 60111, u = e ? Symbol.for("react.concurrent_mode") : 60111, d = e ? Symbol.for("react.forward_ref") : 60112, f = e ? Symbol.for("react.suspense") : 60113, m = e ? Symbol.for("react.suspense_list") : 60120, b = e ? Symbol.for("react.memo") : 60115, A = e ? Symbol.for("react.lazy") : 60116, g = e ? Symbol.for("react.block") : 60121, y = e ? Symbol.for("react.fundamental") : 60117, N = e ? Symbol.for("react.responder") : 60118, W = e ? Symbol.for("react.scope") : 60119;
  function G(v) {
  ...
  return ve.AsyncMode = c, ve.ConcurrentMode = u, ve.ContextConsumer = l, ve.ContextProvider = s, ve.Element = t, ve.ForwardRef = d, ve.Fragment = n, ve.Lazy = A, ve.Memo = b, ve.Portal = r, ve.Profiler = i, ve.StrictMode = o, ve.Suspense = f, ve.isAsyncMode = function(v) {
    return C(v) || G(v) === c;
    ...
    return typeof v == "string" || typeof v == "function" || v === n || v === u || v === i || v === o || v === f || v === m || typeof v == "object" && v !== null && (v.$$typeof === A || v.$$typeof === b || v.$$typeof === s || v.$$typeof === l || v.$$typeof === d || v.$$typeof === y || v.$$typeof === N || v.$$typeof === W || v.$$typeof === g);
  }, ve.typeOf = G, ve;
}
var ye = {};
/** @license React v16.13.1
...
function qs() {
  return Vo || (Vo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function G(z) {
      ...
      z === n || z === u || z === i || z === o || z === f || z === m || typeof z == "object" && z !== null && (z.$$typeof === A || z.$$typeof === b || z.$$typeof === s || z.$$typeof === l || z.$$typeof === d || z.$$typeof === y || z.$$typeof === N || z.$$typeof === W || z.$$typeof === g);
    }
    function C(z) {
    ...
    var v = c, B = u, j = l, R = s, k = t, T = d, I = n, ae = A, $ = b, ne = r, se = i, re = o, ce = f, le = !1;
    function pe(z) {
    ...
    ye.AsyncMode = v, ye.ConcurrentMode = B, ye.ContextConsumer = j, ye.ContextProvider = R, ye.Element = k, ye.ForwardRef = T, ye.Fragment = I, ye.Lazy = ae, ye.Memo = $, ye.Portal = ne, ye.Profiler = se, ye.StrictMode = re, ye.Suspense = ce, ye.isAsyncMode = pe, ye.isConcurrentMode = Y, ye.isContextConsumer = H, ye.isContextProvider = te, ye.isElement = Q, ye.isForwardRef = F, ye.isFragment = _, ye.isLazy = X, ye.isMemo = q, ye.isPortal = U, ye.isProfiler = ee, ye.isStrictMode = ie, ye.isSuspense = fe, ye.isValidElementType = G, ye.typeOf = C;
  }()), ye;
}
var Ho;
function _a() {
...
function Ss() {
  ...
  return Wn = function(l, c) {
    ...
    function y(Y) {
      if (process.env.NODE_ENV !== "production")
        var H = {}, te = 0;
      function Q(_, X, q, U, ee, ie, fe) {
        if (U = U || m, ie = ie || q, fe !== r) {
          if (c) {
            var z = new Error(
        ...
        return X[q] == null ? _ ? X[q] === null ? new g("The " + ee + " `" + ie + "` is marked as required " + ("in `" + U + "`, but its value is `null`.")) : new g("The " + ee + " `" + ie + "` is marked as required in " + ("`" + U + "`, but its value is `undefined`.")) : null : Y(X, q, U, ee, ie);
      }
      var F = Q.bind(null, !1);
      return F.isRequired = Q.bind(null, !0), F;
    }
    function N(Y) {
      function H(te, Q, F, _, X, q) {
        var U = te[Q], ee = re(U);
        if (ee !== Y) {
          var ie = ce(U);
          return new g(
            "Invalid " + _ + " `" + X + "` of type " + ("`" + ie + "` supplied to `" + F + "`, expected ") + ("`" + Y + "`."),
            { expectedType: Y }
          );
        }
        return null;
    ...
    function G(Y) {
      function H(te, Q, F, _, X) {
        if (typeof Y != "function")
          return new g("Property `" + X + "` of component `" + F + "` has invalid PropType notation inside arrayOf.");
        var q = te[Q];
        if (!Array.isArray(q)) {
          var U = re(q);
          return new g("Invalid " + _ + " `" + X + "` of type " + ("`" + U + "` supplied to `" + F + "`, expected an array."));
        }
        for (var ee = 0; ee < q.length; ee++) {
          var ie = Y(q, ee, F, _, X + "[" + ee + "]", r);
    ...
    function C() {
      function Y(H, te, Q, F, _) {
        var X = H[te];
        if (!l(X)) {
          var q = re(X);
          return new g("Invalid " + F + " `" + _ + "` of type " + ("`" + q + "` supplied to `" + Q + "`, expected a single ReactElement."));
        }
        return null;
      }
      return y(Y);
    ...
    function v() {
      function Y(H, te, Q, F, _) {
        ...
        if (!e.isValidElementType(X)) {
          var q = re(X);
          return new g("Invalid " + F + " `" + _ + "` of type " + ("`" + q + "` supplied to `" + Q + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return y(Y);
    ...
    function B(Y) {
      function H(te, Q, F, _, X) {
        if (!(te[Q] instanceof Y)) {
          var q = Y.name || m, U = pe(te[Q]);
          return new g("Invalid " + _ + " `" + X + "` of type " + ("`" + U + "` supplied to `" + F + "`, expected ") + ("instance of `" + q + "`."));
        }
        return null;
      }
      return y(H);
    ...
    function j(Y) {
      ...
      function H(te, Q, F, _, X) {
        for (var q = te[Q], U = 0; U < Y.length; U++)
          if (A(q, Y[U]))
            return null;
        ...
        return new g("Invalid " + _ + " `" + X + "` of value `" + String(q) + "` " + ("supplied to `" + F + "`, expected one of " + ee + "."));
      }
      return y(H);
    }
    function R(Y) {
      function H(te, Q, F, _, X) {
        if (typeof Y != "function")
          return new g("Property `" + X + "` of component `" + F + "` has invalid PropType notation inside objectOf.");
        var q = te[Q], U = re(q);
        if (U !== "object")
          return new g("Invalid " + _ + " `" + X + "` of type " + ("`" + U + "` supplied to `" + F + "`, expected an object."));
        for (var ee in q)
          if (n(q, ee)) {
            var ie = Y(q, ee, F, _, X + "." + ee, r);
            if (ie instanceof Error)
    ...
    function k(Y) {
      ...
      function Q(F, _, X, q, U) {
        for (var ee = [], ie = 0; ie < Y.length; ie++) {
          var fe = Y[ie], z = fe(F, _, X, q, U, r);
          if (z == null)
            return null;
          z.data && n(z.data, "expectedType") && ee.push(z.data.expectedType);
        }
        var Ne = ee.length > 0 ? ", expected one of type [" + ee.join(", ") + "]" : "";
        return new g("Invalid " + q + " `" + U + "` supplied to " + ("`" + X + "`" + Ne + "."));
      }
      return y(Q);
    }
    function T() {
      function Y(H, te, Q, F, _) {
        return ne(H[te]) ? null : new g("Invalid " + F + " `" + _ + "` supplied to " + ("`" + Q + "`, expected a ReactNode."));
      }
      return y(Y);
    }
    function I(Y, H, te, Q, F) {
      return new g(
        (Y || "React class") + ": " + H + " type `" + te + "." + Q + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + F + "`."
      );
    }
    function ae(Y) {
      function H(te, Q, F, _, X) {
        var q = te[Q], U = re(q);
        if (U !== "object")
          return new g("Invalid " + _ + " `" + X + "` of type `" + U + "` " + ("supplied to `" + F + "`, expected `object`."));
        for (var ee in Y) {
          var ie = Y[ee];
          if (typeof ie != "function")
            return I(F, _, X, ee, ce(ie));
          var fe = ie(q, ee, F, _, X + "." + ee, r);
          if (fe)
            return fe;
        }
        return null;
      ...
      function H(te, Q, F, _, X) {
        ...
        for (var ie in ee) {
          ...
          if (n(Y, ie) && typeof fe != "function")
            return I(F, _, X, ie, ce(fe));
          if (!fe)
            return new g(
              "Invalid " + _ + " `" + X + "` key `" + ie + "` supplied to `" + F + "`.\nBad object: " + JSON.stringify(te[Q], null, "  ") + `
Valid keys: ` + JSON.stringify(Object.keys(Y), null, "  ")
            );
          var z = fe(q, ie, F, _, X + "." + ie, r);
          if (z)
            return z;
        }
        return null;
    ...
    function re(Y) {
      var H = typeof Y;
      return Array.isArray(Y) ? "array" : Y instanceof RegExp ? "object" : se(H, Y) ? "symbol" : H;
    }
    function ce(Y) {
...
if (process.env.NODE_ENV !== "production") {
  ...
  Un.exports = Qs()();
var Js = Un.exports;
const a = /* @__PURE__ */ Vs(Js), Ft = Dt.forwardRef(
  (e, t) => {
    const { size: r } = e;
    return /* @__PURE__ */ h(
      "div",
...
const io = (e) => {
  ...
  return /* @__PURE__ */ h(ds, { sx: { backgroundColor: (s) => s.palette.table.header }, children: /* @__PURE__ */ h(Yr, { children: n.map((s) => /* @__PURE__ */ h(Nr, { component: "th", children: s.isSortable ? /* @__PURE__ */ h(
    ps,
    {
      active: t === s.id,
...
const tl = ({
  ...
  return /* @__PURE__ */ h(Wr, { fullWidth: n, ...d, children: /* @__PURE__ */ h(
    Rr,
    {
      control: f,
      name: e,
      render: ({ field: { onChange: m, onBlur: b, value: A, name: g, ref: y } }) => /* @__PURE__ */ h(
        Ha,
        {
          helperText: u,
          multiline: l,
...
function al(e = []) {
  return e.map((t) => /* @__PURE__ */ h(hs, { value: t.id, children: t.name }, t.id));
}
const ri = ({
  data: e,
  name: t,
  ...
  return /* @__PURE__ */ oe(Wr, { fullWidth: !0, children: [
    /* @__PURE__ */ h(ms, { id: l, required: n, disabled: o, children: r }),
    /* @__PURE__ */ h(
      Rr,
      {
        control: u,
...
const sl = {
  ...
  const {
    ...
    row: c
  } = e, [u, d] = st(l), [f, m] = st(i), [b, A] = st(0), [g, y] = st(n), N = (B, j) => {
    const R = f === j && u === rt.ASC;
    d(R ? rt.DESC : rt.ASC), m(j);
  }, W = (B, j) => {
    A(j);
  }, G = (B) => {
    y(parseInt(B.target.value, 10)), A(0);
  }, v = (() => {
    const B = r.map((R, k) => [R, k]);
    return B.sort((R, k) => {
      const T = il(
        R[0],
        k[0],
      ...
      return T !== 0 ? T : R[1] - k[1];
    }), B.map((R) => R[0]).slice(
      b * g,
      b * g + g
    );
  })();
  return /* @__PURE__ */ oe(La, { theme: ni, children: [
    /* @__PURE__ */ h(Fa, { children: /* @__PURE__ */ oe(Za, { children: [
      ...
      /* @__PURE__ */ oe(qa, { children: [
        o && /* @__PURE__ */ h(Yr, { children: /* @__PURE__ */ h(Nr, { colSpan: t.length, align: "center", children: /* @__PURE__ */ h(Ft, {}) }) }),
        (v == null ? void 0 : v.length) > 0 ? v.map((B) => Dt.cloneElement(c, { key: B.id, data: B })) : /* @__PURE__ */ h(Yr, { children: /* @__PURE__ */ h(Nr, { colSpan: t.length, align: "center", children: /* @__PURE__ */ h(ze, { variant: "h6", sx: { textAlign: "center" }, children: "No hay nada por aquí" }) }) })
      ] })
    ] }) }),
    /* @__PURE__ */ h(
      ka,
...
const Xl = Ql, Kl = ({ isoDateTimeString: e, relative: t = !1, showTime: r = !0 }) => {
  ...
  return t ? /* @__PURE__ */ h("span", { children: Gs(n, /* @__PURE__ */ new Date(), {
    locale: Xl
  }) }) : /* @__PURE__ */ h("span", { children: Es(n, o) });
};
Kl.propTypes = {
...
const $l = (e) => {
  ...
  const y = (v, B) => {
    ...
    m({ ...f, per_page: v.target.value, page: 1 });
  }, W = (v, B) => {
    const j = d.get("sort[direction]") === rt.ASC ? rt.DESC : rt.ASC;
    m((R) => ({
      ...R,
      page: 1,
      sort: {
  ...
  return /* @__PURE__ */ oe(ur, { children: [
    /* @__PURE__ */ h(Fa, { sx: { position: "relative" }, children: /* @__PURE__ */ oe(Za, { children: [
      /* @__PURE__ */ h(
        ...
        {
          headCells: t,
          orderBy: d.get("sort[field]"),
          orderDirection: d.get("sort[direction]"),
          handleSortRequest: W
        }
      ),
      /* @__PURE__ */ oe(qa, { children: [
        (b || A) && /* @__PURE__ */ h(Yr, { children: /* @__PURE__ */ h(Nr, { colSpan: t.length, align: "center", children: /* @__PURE__ */ h(Ft, {}) }) }),
        ((G = g == null ? void 0 : g.data) == null ? void 0 : G.length) > 0 && g.data.map((v) => Dt.cloneElement(c, { key: v.id, data: v })),
        !b && !A && ((C = g == null ? void 0 : g.data) == null ? void 0 : C.length) === 0 && /* @__PURE__ */ h(Yr, { children: /* @__PURE__ */ h(Nr, { colSpan: t.length, align: "center", children: /* @__PURE__ */ h(ze, { variant: "h6", sx: { textAlign: "center" }, children: "No hay nada por aquí" }) }) })
      ] })
    ] }) }),
    g && /* @__PURE__ */ h(
      ka,
...
function oc() {
  ...
  return we.ContextConsumer = s, we.ContextProvider = i, we.Element = e, we.ForwardRef = c, we.Fragment = r, we.Lazy = m, we.Memo = f, we.Portal = t, we.Profiler = o, we.StrictMode = n, we.Suspense = u, we.SuspenseList = d, we.isAsyncMode = function() {
    ...
    return typeof y == "string" || typeof y == "function" || y === r || y === o || y === n || y === u || y === d || y === b || typeof y == "object" && y !== null && (y.$$typeof === m || y.$$typeof === f || y.$$typeof === i || y.$$typeof === s || y.$$typeof === c || y.$$typeof === A || y.getModuleId !== void 0);
  }, we.typeOf = g, we;
}
var De = {};
/**
...
function ac() {
  return Qo || (Qo = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), r = Symbol.for("react.fragment"), n = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), i = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), u = Symbol.for("react.suspense"), d = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), m = Symbol.for("react.lazy"), b = Symbol.for("react.offscreen"), A = !1, g = !1, y = !1, N = !1, W = !1, G;
    G = Symbol.for("react.module.reference");
    function C(L) {
      return !!(typeof L == "string" || typeof L == "function" || L === r || L === o || W || L === n || L === u || L === d || N || L === b || A || g || y || typeof L == "object" && L !== null && (L.$$typeof === m || L.$$typeof === f || L.$$typeof === i || L.$$typeof === s || L.$$typeof === c || // This needs to include all possible module reference object
      // types supported by any Flight configuration anywhere since
      // we don't know which Flight build this will end up being used
      // with.
    ...
    var B = s, j = i, R = e, k = c, T = r, I = m, ae = f, $ = t, ne = o, se = n, re = u, ce = d, le = !1, pe = !1;
    function Y(L) {
    ...
    De.ContextConsumer = B, De.ContextProvider = j, De.Element = R, De.ForwardRef = k, De.Fragment = T, De.Lazy = I, De.Memo = ae, De.Portal = $, De.Profiler = ne, De.StrictMode = se, De.Suspense = re, De.SuspenseList = ce, De.isAsyncMode = Y, De.isConcurrentMode = H, De.isContextConsumer = te, De.isContextProvider = Q, De.isElement = F, De.isForwardRef = _, De.isFragment = X, De.isLazy = q, De.isMemo = U, De.isPortal = ee, De.isProfiler = ie, De.isStrictMode = fe, De.isSuspense = z, De.isSuspenseList = Ne, De.isValidElementType = C, De.typeOf = v;
  }()), De;
}
...
function lr(e, t, r) {
  ...
  var s = Ht(e) ? nt(e) : window, l = s.visualViewport, c = !bi() && r, u = (n.left + (c && l ? l.offsetLeft : 0)) / o, d = (n.top + (c && l ? l.offsetTop : 0)) / i, f = n.width / o, m = n.height / i;
  return {
    width: f,
    height: m,
    top: d,
...
function Vr(e) {
  for (var t = nt(e), r = na(e); r && ru(r) && Tt(r).position === "static"; )
    r = na(r);
...
function iu(e) {
  ...
  if (!(!i || !s)) {
    var f = au(o.padding, r), m = po(i), b = c === "y" ? $e : _e, A = c === "y" ? ct : ut, g = r.rects.reference[d] + r.rects.reference[c] - s[c] - r.rects.popper[d], y = s[c] - r.rects.reference[c], N = Vr(i), W = N ? c === "y" ? N.clientHeight || 0 : N.clientWidth || 0 : 0, G = g / 2 - y / 2, C = f[b], v = W - m[d] - f[A], B = W / 2 - m[d] / 2 + G, j = Or(C, B, v), R = c;
    r.modifiersData[n] = (t = {}, t[R] = j, t.centerOffset = j - B, t);
  }
}
function su(e) {
...
function oa(e) {
  var t, r = e.popper, n = e.popperRect, o = e.placement, i = e.variation, s = e.offsets, l = e.position, c = e.gpuAcceleration, u = e.adaptive, d = e.roundOffsets, f = e.isFixed, m = s.x, b = m === void 0 ? 0 : m, A = s.y, g = A === void 0 ? 0 : A, y = typeof d == "function" ? d({
    x: b,
    y: g
  }) : {
    x: b,
  ...
  b = y.x, g = y.y;
  var N = s.hasOwnProperty("x"), W = s.hasOwnProperty("y"), G = _e, C = $e, v = window;
  if (u) {
    var B = Vr(r), j = "clientHeight", R = "clientWidth";
    if (B === nt(r) && (B = Gt(r), Tt(B).position !== "static" && l === "absolute" && (j = "scrollHeight", R = "scrollWidth")), B = B, o === $e || (o === _e || o === ut) && i === Br) {
      C = ct;
      var k = f && B === v && v.visualViewport ? v.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        B[j]
      );
      g -= k - n.height, g *= c ? 1 : -1;
    }
    if (o === _e || (o === $e || o === ct) && i === Br) {
      G = ut;
      var T = f && B === v && v.visualViewport ? v.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        B[R]
      );
      b -= T - n.width, b *= c ? 1 : -1;
  ...
  if (b = ae.x, g = ae.y, c) {
    var $;
    return Object.assign({}, I, ($ = {}, $[C] = W ? "0" : "", $[G] = N ? "0" : "", $.transform = (v.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + g + "px)" : "translate3d(" + b + "px, " + g + "px, 0)", $));
  }
  return Object.assign({}, I, (t = {}, t[C] = W ? g + "px" : "", t[G] = N ? b + "px" : "", t.transform = "", t));
}
function du(e) {
...
function Er(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = n === void 0 ? e.placement : n, i = r.strategy, s = i === void 0 ? e.strategy : i, l = r.boundary, c = l === void 0 ? Lc : l, u = r.rootBoundary, d = u === void 0 ? gi : u, f = r.elementContext, m = f === void 0 ? yr : f, b = r.altBoundary, A = b === void 0 ? !1 : b, g = r.padding, y = g === void 0 ? 0 : g, N = wi(typeof y != "number" ? y : Di(y, Ir)), W = m === yr ? Fc : yr, G = e.rects.popper, C = e.elements[A ? W : m], v = Du(Ht(C) ? C : C.contextElement || Gt(e.elements.popper), c, d, s), B = lr(e.elements.reference), j = Oi({
    reference: B,
    element: G,
    strategy: "absolute",
    placement: o
  }), R = _n(Object.assign({}, G, j)), k = m === yr ? R : B, T = {
    top: v.top - k.top + N.top,
    bottom: k.bottom - v.bottom + N.bottom,
    left: v.left - k.left + N.left,
    right: k.right - v.right + N.right
  }, I = e.modifiersData.offset;
  if (m === yr && I) {
    var ae = I[o];
    Object.keys(T).forEach(function($) {
      var ne = [ut, ct].indexOf($) >= 0 ? 1 : -1, se = [$e, ct].indexOf($) >= 0 ? "y" : "x";
      T[$] += ae[se] * ne;
    });
  }
  return T;
...
function Au(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = r.boundary, i = r.rootBoundary, s = r.padding, l = r.flipVariations, c = r.allowedAutoPlacements, u = c === void 0 ? hi : c, d = cr(n), f = d ? l ? ra : ra.filter(function(A) {
    return cr(A) === d;
...
function xu(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var o = r.mainAxis, i = o === void 0 ? !0 : o, s = r.altAxis, l = s === void 0 ? !0 : s, c = r.fallbackPlacements, u = r.padding, d = r.boundary, f = r.rootBoundary, m = r.altBoundary, b = r.flipVariations, A = b === void 0 ? !0 : b, g = r.allowedAutoPlacements, y = t.options.placement, N = At(y), W = N === y, G = c || (W || !A ? [_r(y)] : Ou(y)), C = [y].concat(G).reduce(function(F, _) {
      return F.concat(At(_) === co ? Au(t, {
        placement: _,
        boundary: d,
        rootBoundary: f,
        padding: u,
    ...
    }, []), v = t.rects.reference, B = t.rects.popper, j = /* @__PURE__ */ new Map(), R = !0, k = C[0], T = 0; T < C.length; T++) {
      var I = C[T], ae = At(I), $ = cr(I) === ir, ne = [$e, ct].indexOf(ae) >= 0, se = ne ? "width" : "height", re = Er(t, {
        placement: I,
        boundary: d,
        rootBoundary: f,
        altBoundary: m,
      ...
      v[se] > B[se] && (ce = _r(ce));
      var le = _r(ce), pe = [];
      if (i && pe.push(re[ae] <= 0), l && pe.push(re[ce] <= 0, re[le] <= 0), pe.every(function(F) {
        return F;
      })) {
        k = I, R = !1;
        break;
...
function Tu(e) {
  var t = e.state, r = e.options, n = e.name, o = r.offset, i = o === void 0 ? [0, 0] : o, s = hi.reduce(function(d, f) {
...
function ju(e) {
  var t = e.state, r = e.options, n = e.name, o = r.mainAxis, i = o === void 0 ? !0 : o, s = r.altAxis, l = s === void 0 ? !1 : s, c = r.boundary, u = r.rootBoundary, d = r.altBoundary, f = r.padding, m = r.tether, b = m === void 0 ? !0 : m, A = r.tetherOffset, g = A === void 0 ? 0 : A, y = Er(t, {
    boundary: c,
    rootBoundary: u,
    padding: f,
    altBoundary: d
  }), N = At(t.placement), W = cr(t.placement), G = !W, C = fo(N), v = Gu(C), B = t.modifiersData.popperOffsets, j = t.rects.reference, R = t.rects.popper, k = typeof g == "function" ? g(Object.assign({}, t.rects, {
    placement: t.placement
  })) : g, T = typeof k == "number" ? {
    mainAxis: k,
    altAxis: k
    ...
    mainAxis: 0,
    altAxis: 0
  }, k), I = t.modifiersData.offset ? t.modifiersData.offset[t.placement] : null, ae = {
    x: 0,
    y: 0
  };
  if (B) {
    if (i) {
      var $, ne = C === "y" ? $e : _e, se = C === "y" ? ct : ut, re = C === "y" ? "height" : "width", ce = B[C], le = ce + y[ne], pe = ce - y[se], Y = b ? -R[re] / 2 : 0, H = W === ir ? j[re] : R[re], te = W === ir ? -R[re] : -j[re], Q = t.elements.arrow, F = b && Q ? po(Q) : {
        width: 0,
        height: 0
      }, _ = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : yi(), X = _[ne], q = _[se], U = Or(0, j[re], F[re]), ee = G ? j[re] / 2 - Y - U - X - T.mainAxis : H - U - X - T.mainAxis, ie = G ? -j[re] / 2 + Y + U + q + T.mainAxis : te + U + q + T.mainAxis, fe = t.elements.arrow && Vr(t.elements.arrow), z = fe ? C === "y" ? fe.clientTop || 0 : fe.clientLeft || 0 : 0, Ne = ($ = I == null ? void 0 : I[C]) != null ? $ : 0, L = ce + ee - Ne - z, S = ce + ie - Ne, We = Or(b ? ln(le, L) : le, ce, b ? Vt(pe, S) : pe);
      B[C] = We, ae[C] = We - ce;
    }
    if (l) {
      var me, qe = C === "x" ? $e : _e, Re = C === "x" ? ct : ut, Ie = B[v], Le = v === "y" ? "height" : "width", Ve = Ie + y[qe], ft = Ie - y[Re], Qe = [$e, _e].indexOf(N) !== -1, Ze = (me = I == null ? void 0 : I[v]) != null ? me : 0, ot = Qe ? Ve : Ie - j[Le] - R[Le] - Ze + T.altAxis, Me = Qe ? Ie + j[Le] + R[Le] - Ze - T.altAxis : ft, xe = b && Qe ? ou(ot, Ie, Me) : Or(b ? ot : Ve, Ie, b ? Me : ft);
      B[v] = xe, ae[v] = xe - Ie;
    }
  ...
  return function(l, c, u) {
    ...
    var d = {
      ...
      setOptions: function(N) {
        ...
        g(), d.options = Object.assign({}, i, d.options, W), d.scrollParents = {
          reference: Ht(l) ? xr(l) : l.contextElement ? xr(l.contextElement) : [],
          popper: xr(c)
        };
      ...
      forceUpdate: function() {
        if (!m) {
          var N = d.elements, W = N.reference, G = N.popper;
          if (ua(W, G)) {
            d.rects = {
            ...
            for (var C = 0; C < d.orderedModifiers.length; C++) {
              ...
              var v = d.orderedModifiers[C], B = v.fn, j = v.options, R = j === void 0 ? {} : j, k = v.name;
    ...
    function A() {
      d.orderedModifiers.forEach(function(y) {
        var N = y.name, W = y.options, G = W === void 0 ? {} : W, C = y.effect;
...
const cn = /* @__PURE__ */ M.forwardRef(function(t, r) {
  const {
    ...
    container: o,
    disablePortal: i = !1
  } = t, [s, l] = M.useState(null), c = Nt(/* @__PURE__ */ M.isValidElement(n) ? n.ref : null, r);
  if (ar(() => {
...
const _u = () => xt({
  ...
  } = t, y = Ye(t, Xu), N = M.useRef(null), W = Nt(N, r), G = M.useRef(null), C = Nt(G, m), v = M.useRef(C);
  ar(() => {
    v.current = C;
  }, [C]), M.useImperativeHandle(m, () => G.current, []);
  const B = Ju(d, s), [j, R] = M.useState(B), [k, T] = M.useState(un(o));
  M.useEffect(() => {
    ...
    if (process.env.NODE_ENV !== "production" && k && hn(k) && k.nodeType === 1) {
...
`));
    ...
    const ce = Uu(k, N.current, x({
      placement: B
    }, f, {
      modifiers: re
    }));
    return v.current(ce), () => {
      ce.destroy(), v.current(null);
    };
  }, [k, l, c, u, f, B]);
  const I = {
    placement: j
  ...
  const {
    ...
    slotProps: y = {},
    slots: N = {}
  } = t, W = Ye(t, Ku), [G, C] = M.useState(!0), v = () => {
    C(!1);
  }, B = () => {
    C(!0);
  };
  ...
  if (i)
    ...
    const T = un(n);
    j = T && hn(T) ? sn(T).body : sn(null).body;
  }
  const R = !d && c && (!g || G) ? "none" : void 0, k = g ? {
    in: d,
    onEnter: v,
    onExited: B
  } : void 0;
...
function od(e) {
  const {
    ...
    inputValue: k,
    isOptionEqualToValue: T = (w, D) => w === D,
    multiple: I = !1,
    onChange: ae,
    onClose: $,
  ...
  F = (w) => {
    ...
    if (typeof D != "string") {
      if (process.env.NODE_ENV !== "production") {
        const O = D === void 0 ? "undefined" : `${typeof D} (${D})`;
        console.error(`MUI: The \`getOptionLabel\` method of ${u} returned ${O} instead of a string for ${JSON.stringify(w)}.`);
      }
      return String(D);
    }
    return D;
  };
  const _ = M.useRef(!1), X = M.useRef(!0), q = M.useRef(null), U = M.useRef(null), [ee, ie] = M.useState(null), [fe, z] = M.useState(-1), Ne = o ? 0 : -1, L = M.useRef(Ne), [S, We] = $r({
    controlled: te,
    default: d,
    name: u
  }), [me, qe] = $r({
    ...
    name: u,
    state: "inputValue"
  }), [Re, Ie] = M.useState(!1), Le = M.useCallback((w, D) => {
    if (!(I ? S.length < D.length : D !== null) && !l)
      return;
    let E;
    if (I)
      E = "";
    ...
    me !== E && (qe(E), se && se(w, E, "reset"));
  }, [F, me, I, se, qe, l, S]), [Ve, ft] = $r({
    controlled: ce,
    default: !1,
    name: u,
    state: "open"
  }), [Qe, Ze] = M.useState(!0), ot = !I && S != null && me === F(S), Me = Ve && !Y, xe = Me ? y(
    pe.filter((w) => !(N && (I ? S : [S]).some((D) => D !== null && T(w, D)))),
  ...
  if (process.env.NODE_ENV !== "production" && S !== null && !W && pe.length > 0) {
    const w = (I ? S : [S]).filter((D) => !pe.some((O) => T(O, D)));
...
`));
  ...
  const at = Mt((w) => {
    w === -1 ? q.current.focus() : ee.querySelector(`[data-tag-index="${w}"]`).focus();
  });
  M.useEffect(() => {
    I && fe > S.length - 1 && (z(-1), at(-1));
  }, [S, I, fe, at]);
  function Pt(w, D) {
    if (!U.current || w === -1)
      return -1;
    let O = w;
    for (; ; ) {
      if (D === "next" && O === xe.length || D === "previous" && O === -1)
        return -1;
      const E = U.current.querySelector(`[data-option-index="${O}"]`), Z = A ? !1 : !E || E.disabled || E.getAttribute("aria-disabled") === "true";
      if (E && !E.hasAttribute("tabindex") || Z)
        O += D === "next" ? 1 : -1;
      else
        return O;
    }
  ...
  const ke = Mt(({
    ...
    if (L.current = D, D === -1 ? q.current.removeAttribute("aria-activedescendant") : q.current.setAttribute("aria-activedescendant", `${Q}-option-${D}`), ne && ne(w, D === -1 ? null : xe[D], O), !U.current)
      return;
    ...
    const ue = U.current.querySelector(`[data-option-index="${D}"]`);
    if (ue && (ue.classList.add(`${r}-focused`), O === "keyboard" && ue.classList.add(`${r}-focusVisible`), Z.scrollHeight > Z.clientHeight && O !== "mouse" && O !== "touch")) {
      ...
      Fe > he ? Z.scrollTop = Fe - Z.clientHeight : de.offsetTop - de.offsetHeight * (v ? 1.3 : 0) < Z.scrollTop && (Z.scrollTop = de.offsetTop - de.offsetHeight * (v ? 1.3 : 0));
    }
  }), Xe = Mt(({
    event: w,
    diff: D,
    ...
    const ue = Pt((() => {
      ...
      if (D === "end")
        return de;
      const he = L.current + D;
      return he < 0 ? he === -1 && R ? -1 : g && L.current !== -1 || Math.abs(D) > 1 ? 0 : de : he > de ? he === de + 1 && R ? -1 : g || Math.abs(D) > 1 ? de : 0 : he;
    })(), O);
    if (ke({
      index: ue,
      reason: E,
    ...
    const w = (D, O) => {
      const E = D ? F(D) : "", Z = O ? F(O) : "";
      return E === Z;
    };
    if (L.current !== -1 && J.filteredOptions && J.filteredOptions.length !== xe.length && J.inputValue === me && (I ? S.length === J.value.length && J.value.every((D, O) => F(S[O]) === F(D)) : w(J.value, S))) {
      const D = J.filteredOptions[L.current];
      if (D && xe.some((E) => F(E) === F(D)))
        return !0;
    }
    return !1;
  }, vt = M.useCallback(() => {
    ...
    if (U.current) {
      if (w != null) {
        const D = xe[L.current];
        if (I && D && Vn(S, (E) => T(D, E)) !== -1)
          return;
        const O = Vn(xe, (E) => T(E, w));
        O === -1 ? Xe({
          diff: "reset"
        }) : ke({
          index: O
...
`)));
  ...
  const gt = (w) => {
    Ve || (ft(!0), Ze(!0), re && re(w));
  }, Ke = (w, D) => {
    Ve && (ft(!1), $ && $(w, D));
  }, et = (w, D, O, E) => {
    if (I) {
      if (S.length === D.length && S.every((Z, ue) => Z === D[ue]))
        return;
    } else if (S === D)
      return;
    ae && ae(w, D, O, E), We(D);
  }, Ue = M.useRef(!1), ht = (w, D, O = "selectOption", E = "options") => {
    let Z = O, ue = D;
    if (I) {
      if (ue = Array.isArray(S) ? S.slice() : [], process.env.NODE_ENV !== "production") {
        const he = ue.filter((Fe) => T(D, Fe));
...
`));
      ...
      const de = Vn(ue, (he) => T(D, he));
      de === -1 ? ue.push(D) : E !== "freeSolo" && (ue.splice(de, 1), Z = "removeOption");
    }
    Le(w, ue), et(w, ue, Z, {
      option: D
    }), !m && (!w || !w.ctrlKey && !w.metaKey) && Ke(w, Z), (s === !0 || s === "touch" && Ue.current || s === "mouse" && !Ue.current) && q.current.blur();
  };
  function Wt(w, D) {
    if (w === -1)
      return -1;
    let O = w;
    for (; ; ) {
      if (D === "next" && O === S.length || D === "previous" && O === -1)
        return -1;
  ...
  const Bt = (w, D) => {
    ...
    me === "" && Ke(w, "toggleInput");
    let O = fe;
    fe === -1 ? me === "" && D === "previous" && (O = S.length - 1) : (O += D === "next" ? 1 : -1, O < 0 && (O = 0), O === S.length && (O = -1)), O = Wt(O, D), z(O), at(O);
  }, Zt = (w) => {
    _.current = !0, qe(""), se && se(w, "", "clear"), et(w, I ? [] : null, "clear");
  }, qt = (w) => (D) => {
    if (w.onKeyDown && w.onKeyDown(D), !D.defaultMuiPrevented && (fe !== -1 && ["ArrowLeft", "ArrowRight"].indexOf(D.key) === -1 && (z(-1), at(-1)), D.which !== 229))
      switch (D.key) {
        case "Home":
          Me && B && (D.preventDefault(), Xe({
            diff: "start",
            direction: "next",
            reason: "keyboard",
            event: D
        ...
        case "Enter":
          if (L.current !== -1 && Me) {
            const O = xe[L.current], E = G ? G(O) : !1;
            if (D.preventDefault(), E)
              return;
            ht(D, O, "selectOption"), n && q.current.setSelectionRange(q.current.value.length, q.current.value.length);
          } else
            W && me !== "" && ot === !1 && (I && D.preventDefault(), ht(D, me, "createOption", "freeSolo"));
          break;
        case "Escape":
          Me ? (D.preventDefault(), D.stopPropagation(), Ke(D, "escape")) : c && (me !== "" || I && S.length > 0) && (D.preventDefault(), D.stopPropagation(), Zt(D));
          break;
        case "Backspace":
          if (I && !Y && me === "" && S.length > 0) {
            const O = fe === -1 ? S.length - 1 : fe, E = S.slice();
            E.splice(O, 1), et(D, E, "removeOption", {
              option: S[O]
            });
          }
          break;
        case "Delete":
          if (I && !Y && me === "" && S.length > 0 && fe !== -1) {
    ...
    Ie(!0), le && !_.current && gt(w);
  }, kt = (w) => {
    if (t(U)) {
      q.current.focus();
      return;
    }
    Ie(!1), X.current = !0, _.current = !1, i && L.current !== -1 && Me ? ht(w, xe[L.current], "blur") : i && W && me !== "" ? ht(w, me, "blur", "freeSolo") : l && Le(w, S), Ke(w, "blur");
  }, Et = (w) => {
    const D = w.target.value;
    me !== D && (qe(D), Ze(!1), se && se(w, D, "input")), D === "" ? !f && !I && et(w, null, "clear") : gt(w);
  }, He = (w) => {
    const D = Number(w.currentTarget.getAttribute("data-option-index"));
    L.current !== D && ke({
      event: w,
      index: D,
      reason: "mouse"
    ...
    const D = Number(w.currentTarget.getAttribute("data-option-index"));
    ht(w, xe[D], "selectOption"), Ue.current = !1;
  }, kr = (w) => (D) => {
    const O = S.slice();
    O.splice(w, 1), et(D, O, "removeOption", {
      option: S[w]
    });
  }, Ut = (w) => {
    Ve ? Ke(w, "toggleInput") : gt(w);
  }, Ur = (w) => {
    w.currentTarget.contains(w.target) && w.target.getAttribute("id") !== Q && w.preventDefault();
  }, mr = (w) => {
    w.currentTarget.contains(w.target) && (q.current.focus(), H && X.current && q.current.selectionEnd - q.current.selectionStart === 0 && q.current.select(), X.current = !1);
  }, p = (w) => {
    (me === "" || !Ve) && Ut(w);
  };
  let P = W && me.length > 0;
  P = P || (I ? S.length > 0 : S !== null);
  let V = xe;
  if (v) {
    ...
    V = xe.reduce((O, E, Z) => {
      const ue = v(E);
      return O.length > 0 && O[O.length - 1].group === ue ? O[O.length - 1].options.push(E) : (process.env.NODE_ENV !== "production" && (w.get(ue) && !D && (console.warn(`MUI: The options provided combined with the \`groupBy\` method of ${u} returns duplicated headers.`, "You can solve the issue by sorting the options with the output of `groupBy`."), D = !0), w.set(ue, !0)), O.push({
        key: Z,
        index: Z,
        group: ue,
        options: [E]
  ...
  return b && Re && kt(), {
    ...
    getOptionProps: ({
      ...
      const O = (I ? S : [S]).some((Z) => Z != null && T(D, Z)), E = G ? G(D) : !1;
      return {
        key: F(D),
        tabIndex: -1,
        role: "option",
...
const Ni = tp();
Ni.filterProps = ["sx"];
const yo = Ni, rp = ["breakpoints", "palette", "spacing", "shape"];
function wo(e = {}, ...t) {
  const {
    breakpoints: r = {},
    palette: n = {},
...
function bp(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, l = {}) => {
    id(s, (C) => C.filter((v) => !(v != null && v.__mui_systemSx)));
    const {
      name: c,
      slot: u,
    ...
    let y;
    process.env.NODE_ENV !== "production" && c && (y = `${c}-${ha(u || "Root")}`);
    let N = en;
    u === "Root" || u === "root" ? N = n : u ? N = o : dp(s) && (N = void 0);
    const W = ad(s, x({
      shouldForwardProp: N,
      label: y
    }, b)), G = (C, ...v) => {
      const B = v ? v.map((T) => typeof T == "function" && T.__emotion_real !== T ? (I) => T(x({}, I, {
        theme: wr(x({}, I, {
          defaultTheme: r,
          themeId: t
        }))
      ...
      c && m && B.push((T) => {
        ...
        return mp(T, fp(c, I), I, c);
      }), g || B.push(i);
      const R = B.length - v.length;
      if (Array.isArray(C) && R > 0) {
        const T = new Array(R).fill("");
        j = [...C, ...T], j.raw = [...C.raw, ...T];
      } else
      ...
      if (process.env.NODE_ENV !== "production") {
        let T;
        c && (T = `${c}${K(u || "")}`), T === void 0 && (T = `Styled(${lc(s)})`), k.displayName = T;
      }
...
function ba(e) {
  e = Lt(e);
  let t = e.type === "hsl" || e.type === "hsla" ? Lt(Dp(e)).values : e.values;
...
function Ge(e, t) {
  return e = Lt(e), t = Do(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, Yn(e);
}
function Ap(e, t) {
  if (e = Lt(e), t = Do(t), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - t;
...
const Cp = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, $t = Gp, jp = ["mode", "contrastThreshold", "tonalOffset"], ya = {
...
function Lp(e) {
  ...
  function f(g) {
    const y = va(g, Hn.text.primary) >= r ? Hn.text.primary : ya.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const N = va(g, y);
      N < 3 && console.error([`MUI: The contrast ratio of ${N}:1 for ${y} on ${g}`, "falls below the WCAG recommended absolute minimum contrast ratio of 3:1.", "https://www.w3.org/TR/2008/REC-WCAG20-20081211/#visual-audio-contrast-contrast"].join(`
`));
    }
    return y;
  }
  const m = ({
    ...
    if (g = x({}, g), !g.main && g[N] && (g.main = g[N]), !g.hasOwnProperty("main"))
      throw new Error(process.env.NODE_ENV !== "production" ? `MUI: The color${y ? ` (${y})` : ""} provided to augmentColor(color) is invalid.
The color object needs to have a \`main\` property or a \`${N}\` property.` : or(11, y ? ` (${y})` : "", N));
...
} });` : or(12, y ? ` (${y})` : "", JSON.stringify(g.main)));
    return wa(g, "light", W, n), wa(g, "dark", G, n), g.contrastText || (g.contrastText = f(g.main)), g;
  }, b = {
    dark: Hn,
    light: ya
  };
...
function qp(e, t) {
  ...
  const b = o / 14, A = f || ((N) => `${N / u * b}rem`), g = (N, W, G, C, v) => x({
    fontFamily: n,
    fontWeight: N,
    fontSize: A(W),
    ...
    const d = ["active", "checked", "completed", "disabled", "error", "expanded", "focused", "focusVisible", "required", "selected"], f = (m, b) => {
      ...
      for (A in m) {
        ...
        if (d.indexOf(A) !== -1 && Object.keys(g).length > 0) {
          if (process.env.NODE_ENV !== "production") {
            const y = pt("", A);
            console.error([`MUI: The \`${b}\` component increases the CSS specificity of the \`${A}\` internal state.`, "You can not override it like this: ", JSON.stringify(m, null, 2), "", `Instead, you need to use the '&.${y}' syntax:`, JSON.stringify({
              root: {
                [`&.${y}`]: g
              }
...
const Ei = (e) => en(e) && e !== "classes", sf = bp({
  ...
  const o = Ti(), i = bt({
    ...
    slots: G,
    slotProps: C
  } = i, v = Ye(i, cf), B = (n = G == null ? void 0 : G.root) != null ? n : c == null ? void 0 : c.Root, j = x({
    anchorEl: s,
    container: d,
    disablePortal: f,
    keepMounted: m,
...
function Ri(e) {
  const {
    ...
    onExited: c,
    timeout: u
  } = e, [d, f] = M.useState(!1), m = Ae(t, r.ripple, r.rippleVisible, n && r.ripplePulsate), b = {
    width: s,
    height: s,
    top: -(s / 2) + i,
    left: -(s / 2) + o
...
const Yf = Se("MuiTouchRipple", ["root", "ripple", "rippleVisible", "ripplePulsate", "child", "childLeaving", "childPulsate"]), it = Yf, Nf = ["center", "classes", "className"];
let Nn = (e) => e, Ma, Ya, Na, Ta;
const eo = 550, Tf = 80, Pf = ro(Ma || (Ma = Nn`
  0% {
    transform: scale(0);
    opacity: 0.1;
  }
...
`), it.rippleVisible, Pf, eo, ({
  ...
  const n = bt({
    ...
    classes: i = {},
    className: s
  } = n, l = Ye(n, Nf), [c, u] = M.useState([]), d = M.useRef(0), f = M.useRef(null);
  M.useEffect(() => {
    f.current && (f.current(), f.current = null);
  }, [c]);
  const m = M.useRef(!1), b = M.useRef(0), A = M.useRef(null), g = M.useRef(null);
  M.useEffect(() => () => {
    b.current && clearTimeout(b.current);
  }, []);
  const y = M.useCallback((C) => {
    const {
      pulsate: v,
      rippleX: B,
      rippleY: j,
  ...
  }, [i]), N = M.useCallback((C = {}, v = {}, B = () => {
  }) => {
    const {
      pulsate: j = !1,
      center: R = o || v.pulsate,
      fakeElement: k = !1
      // For test purposes
    } = v;
    ...
    const T = k ? null : g.current, I = T ? T.getBoundingClientRect() : {
      width: 0,
      height: 0,
      left: 0,
      top: 0
    ...
    if (R)
      ...
      const se = Math.max(Math.abs((T ? T.clientWidth : 0) - ae), ae) * 2 + 2, re = Math.max(Math.abs((T ? T.clientHeight : 0) - $), $) * 2 + 2;
    ...
    A.current = null, u((B) => B.length > 0 ? B.slice(1) : B), f.current = v;
  }, []);
  return M.useImperativeHandle(r, () => ({
    pulsate: W,
    start: N,
    stop: G
  }), [W, N, G]), /* @__PURE__ */ h(Gf, x({
...
const Rf = Se("MuiButtonBase", ["root", "disabled", "focusVisible"]), If = Rf, Vf = ["action", "centerRipple", "children", "className", "component", "disabled", "disableRipple", "disableTouchRipple", "focusRipple", "focusVisibleClassName", "LinkComponent", "onBlur", "onClick", "onContextMenu", "onDragLeave", "onFocus", "onFocusVisible", "onKeyDown", "onKeyUp", "onMouseDown", "onMouseLeave", "onMouseUp", "onTouchEnd", "onTouchMove", "onTouchStart", "tabIndex", "TouchRippleProps", "touchRippleRef", "type"], Hf = (e) => {
  ...
  const n = bt({
    ...
    touchRippleRef: ne,
    type: se
  } = n, re = Ye(n, Vf), ce = M.useRef(null), le = M.useRef(null), pe = Nt(le, ne), {
    isFocusVisibleRef: Y,
    onFocus: H,
    onBlur: te,
    ref: Q
  } = ui(), [F, _] = M.useState(!1);
  u && F && _(!1), M.useImperativeHandle(o, () => ({
    focusVisible: () => {
      _(!0), ce.current.focus();
    }
  }), []);
  const [X, q] = M.useState(!1);
  M.useEffect(() => {
    q(!0);
  }, []);
  const U = X && !d && !u;
  ...
  function ee(J, mt, at = f) {
    return Mt((Pt) => (mt && mt(Pt), !at && le.current && le.current[J](Pt), !0));
  }
  const ie = ee("start", B), fe = ee("stop", y), z = ee("stop", N), Ne = ee("stop", R), L = ee("stop", (J) => {
    F && J.preventDefault(), j && j(J);
  }), S = ee("start", I), We = ee("stop", k), me = ee("stop", T), qe = ee("stop", (J) => {
    te(J), Y.current === !1 && _(!1), A && A(J);
  }, !1), Re = Mt((J) => {
    ce.current || (ce.current = J.currentTarget), H(J), Y.current === !0 && (_(!0), G && G(J)), W && W(J);
  }), Ie = () => {
    const J = ce.current;
    return c && c !== "button" && !(J.tagName === "A" && J.href);
  }, Le = M.useRef(!1), Ve = Mt((J) => {
    ...
    })), v && v(J), g && J.target === J.currentTarget && Ie() && J.key === " " && !J.defaultPrevented && g(J);
  });
  let Qe = c;
...
}), No = /* @__PURE__ */ M.forwardRef(function(t, r) {
  const n = bt({
    props: t,
    name: "MuiSvgIcon"
  }), {
    ...
    titleAccess: f,
    viewBox: m = "0 0 24 24"
  } = n, b = Ye(n, Xf), A = /* @__PURE__ */ M.isValidElement(o) && o.type === "svg", g = x({}, n, {
    color: s,
    component: l,
    fontSize: c,
...
const Fi = /* @__PURE__ */ M.forwardRef(function(t, r) {
  ...
  } = n, v = Ye(n, tm), B = M.useRef(null), j = Nt(B, r), R = (pe) => {
    pe.stopPropagation(), A && A(pe);
  }, k = (pe) => {
    pe.currentTarget === pe.target && Ba(pe) && pe.preventDefault(), g && g(pe);
  }, T = (pe) => {
    pe.currentTarget === pe.target && (A && Ba(pe) ? A(pe) : pe.key === "Escape" && B.current && B.current.blur()), y && y(pe);
  ...
  let le = null;
  return f && /* @__PURE__ */ M.isValidElement(f) && (le = /* @__PURE__ */ M.cloneElement(f, {
...
const am = Fi, im = Se("MuiInputBase", ["root", "formControl", "focused", "disabled", "adornedStart", "adornedEnd", "error", "sizeSmall", "multiline", "colorSecondary", "fullWidth", "hiddenLabel", "readOnly", "input", "inputSizeSmall", "inputMultiline", "inputTypeSearch", "inputAdornedStart", "inputAdornedEnd", "inputHiddenLabel"]), yt = im, sm = x({}, yt, Se("MuiInput", ["root", "underline", "input"])), Ln = sm, lm = x({}, yt, Se("MuiOutlinedInput", ["root", "notchedOutline", "input"])), Ea = lm, cm = x({}, yt, Se("MuiFilledInput", ["root", "underline", "input"])), _t = cm, um = Tn(/* @__PURE__ */ h("path", {
...
const mm = ["autoComplete", "autoHighlight", "autoSelect", "blurOnSelect", "ChipProps", "className", "clearIcon", "clearOnBlur", "clearOnEscape", "clearText", "closeText", "componentsProps", "defaultValue", "disableClearable", "disableCloseOnSelect", "disabled", "disabledItemsFocusable", "disableListWrap", "disablePortal", "filterOptions", "filterSelectedOptions", "forcePopupIcon", "freeSolo", "fullWidth", "getLimitTagsText", "getOptionDisabled", "getOptionLabel", "isOptionEqualToValue", "groupBy", "handleHomeEndKeys", "id", "includeInputInList", "inputValue", "limitTags", "ListboxComponent", "ListboxProps", "loading", "loadingText", "multiple", "noOptionsText", "onChange", "onClose", "onHighlightChange", "onInputChange", "onOpen", "open", "openOnFocus", "openText", "options", "PaperComponent", "PopperComponent", "popupIcon", "readOnly", "renderGroup", "renderInput", "renderOption", "renderTags", "selectOnFocus", "size", "slotProps", "value"], gm = ["ref"], hm = (e) => {
  ...
  [`& .${_t.root}.${yt.hiddenLabel}.${yt.sizeSmall}`]: {
    [`& .${ge.input}`]: {
      paddingTop: 8,
      paddingBottom: 9
    }
  ...
  })), et = !v && !j && mt && !z, Ue = (!$ || ae === !0) && ae !== !1, {
    onMouseDown: ht
  } = Ve(), {
    ref: Wt
  } = te ?? {}, Bt = Me(), {
    ref: Zt
  } = Bt, qt = Ye(Bt, gm), fr = Nt(Zt, Wt), Et = re || ((O) => {
    var E;
  ...
  if (_ && J.length > 0) {
    ...
    We ? Je = We(J, O, He) : Je = J.map((E, Z) => /* @__PURE__ */ h(am, x({
      label: Et(E),
      size: qe
    }, O({
      index: Z
  ...
  if (Y > -1 && Array.isArray(Je)) {
    const O = Je.length - Y;
    !Xe && O > 0 && (Je = Je.splice(0, Y), Je.push(/* @__PURE__ */ h("span", {
      className: je.tag,
      children: se(O)
    }, Je.length)));
  }
  const Ut = Ne || ((O) => /* @__PURE__ */ oe("li", {
  ...
  }, P = (n = Re.clearIndicator) != null ? n : G.clearIndicator, V = (o = Re.paper) != null ? o : G.paper, w = (i = Re.popper) != null ? i : G.popper, D = (s = Re.popupIndicator) != null ? s : G.popupIndicator;
  return /* @__PURE__ */ oe(M.Fragment, {
    children: [/* @__PURE__ */ h(bm, x({
      ...
      children: L({
        ...
        InputProps: x({
          ...
          endAdornment: /* @__PURE__ */ oe(vm, {
            ...
            ownerState: He,
            children: [et ? /* @__PURE__ */ h(ym, x({}, Ze(), {
              "aria-label": N,
              title: N,
              ownerState: He
            }, P, {
              className: Ae(je.clearIndicator, P == null ? void 0 : P.className),
              children: A
              ...
              className: Ae(je.popupIndicator, D == null ? void 0 : D.className),
              children: fe
            })) : null]
          })
        }),
      ...
      className: Ae(je.popper, w == null ? void 0 : w.className),
...
const Nm = Zi, Tm = Ci(), Pm = (e) => {
  const {
    ...
    multiple: l,
    ...c
  } = e, { control: u } = zr(), [d, f] = st([]), [m, b] = st(l ? [] : ""), [A, g] = st(""), { isFetching: y, refetch: N, isFetched: W } = Qa({
    queryKey: ["options", A],
  ...
  const G = (j, R, k) => {
    ...
    b(R), k(R);
  }, C = (j) => typeof j == "string" ? j : j.inputValue ? j.inputValue : i ? i(j) : j.name, v = (j, R) => (
    // eslint-disable-next-line
    /* @__PURE__ */ ss("li", { ...j, key: R.id ?? j.key }, i ? i(R) : R.name)
  ), B = (j, R) => {
    const k = Tm(j, R), T = String(R.inputValue).trim(), I = k.length === 0;
    return o && T !== "" && (I || !j.find((ae) => ae.name === T)) && k.push({
      inputValue: T,
      name: `Agregar "${T}"`
    }), !o && I && T !== "" && !y && W && k.push({
      inputValue: T,
  ...
  return /* @__PURE__ */ h(Wr, { fullWidth: !0, ...c, children: /* @__PURE__ */ h(
    Rr,
    {
      control: u,
      name: r,
      render: ({ field: { ref: j, onChange: R, ...k } }) => /* @__PURE__ */ h(
        Nm,
        {
          multiple: l,
          value: m,
          onChange: (T, I) => G(T, I, R),
          onKeyDown: (T) => g(T.target.value),
          filterOptions: B,
          options: d,
          selectOnFocus: !0,
          clearOnBlur: !0,
            ...
            Ha,
            {
              ...
              InputProps: {
                ...
                endAdornment: /* @__PURE__ */ oe(ur, { children: [
                  y ? /* @__PURE__ */ h(Ia, { color: "inherit", size: 20 }) : null,
...
const Bm = (e, t) => {
  ...
  for (let n in t)
    if (!r[n] || r[n] === !1)
      return !1;
  return !0;
}, Em = ({ user: e, has: t, ...r }) => Bm(e, t) ? /* @__PURE__ */ h(ys, { ...r }) : null;
Em.propTypes = {
  has: a.object,
  user: a.object
};
...
var ki = To.default = void 0, Rm = zm(Zr()), Im = qr, Vm = (0, Rm.default)(/* @__PURE__ */ (0, Im.jsx)("path", {
...
const Fm = Ui, Zm = ["children", "color", "component", "className", "disabled", "disableElevation", "disableFocusRipple", "endIcon", "focusVisibleClassName", "fullWidth", "size", "startIcon", "type", "variant"], qm = (e) => {
  ...
  const n = M.useContext(Fm), o = lo(n, t), i = bt({
    props: o,
    name: "MuiButton"
  }), {
    children: s,
  ...
  return /* @__PURE__ */ oe(km, x({
    ownerState: v,
    className: Ae(n.className, B.root, u),
    component: c,
    disabled: d,
    focusRipple: !m,
    focusVisibleClassName: Ae(B.focusVisible, A),
    ref: r,
    type: W
  }, C, {
    classes: B,
...
const $m = ({ children: e, open: t, onClose: r, onAccept: n, onCancel: o }) => {
  ...
  return /* @__PURE__ */ h(
    Ee,
    {
      ...
      onClick: u,
      children: /* @__PURE__ */ h(ws, { in: t, direction: "right", children: /* @__PURE__ */ oe(
        fn,
        {
...
const dg = (e) => {
  ...
  const n = bt({
    ...
    wrap: g = "wrap",
    zeroMinWidth: y = !1
  } = i, N = Ye(i, ng), W = b || A, G = c || A, C = M.useContext(Ra), v = d ? l || 12 : C, B = {}, j = x({}, N);
  o.keys.forEach((T) => {
    N[T] != null && (B[T] = N[T], delete j[T]);
  });
  const R = x({}, i, {
    columns: v,
    container: d,
...
function kg() {
  return /* @__PURE__ */ h(La, { theme: ni, children: /* @__PURE__ */ oe(Zn, { container: !0, height: "100dvh", sx: {}, children: [
    /* @__PURE__ */ h(
      Zn,
      {
        item: !0,
...
const $i = ({ children: e, onToggleDrawer: t, open: r }) => {
  ...
  return rr(() => {
    r && o && t(!1);
  }, [n]), o ? /* @__PURE__ */ oe(es, { open: r, onToggleDrawer: t, children: [
    /* @__PURE__ */ h(on, {}),
    e
  ] }) : /* @__PURE__ */ oe(_i, { variant: "permanent", open: r, children: [
    /* @__PURE__ */ h(on, {}),
    e
  ] });
};
...
const es = ({ onToggleDrawer: e, open: t, children: r }) => /* @__PURE__ */ h(
  Ua,
  {
    variant: "temporary",
    anchor: "left",
    ...
    /* @__PURE__ */ h(Yg, { position: "absolute", open: n, children: /* @__PURE__ */ oe(on, { sx: { position: "relative" }, children: [
      ...
      /* @__PURE__ */ oe(
        Ee,
        {
          ...
          ref: i,
          children: [
            /* @__PURE__ */ h(rn, { sx: { mr: 1, color: "#fff" }, children: /* @__PURE__ */ h(ns, {}) }),
            /* @__PURE__ */ h(
              Sn,
              {
...
function Ng({ ItemsList: e, logout: t, user: r }) {
  ...
  return /* @__PURE__ */ oe(an, { sx: { display: "flex" }, children: [
    ...
    /* @__PURE__ */ h($i, { open: n, onToggleDrawer: i, children: /* @__PURE__ */ h(e, {}) }),
    /* @__PURE__ */ oe(
      an,
      {
        component: "main",
        ...
        children: [
          ...
          /* @__PURE__ */ h(
            Ys,
            {
              ...
              children: /* @__PURE__ */ h(ls, { fallback: /* @__PURE__ */ h(Ft, {}), children: /* @__PURE__ */ h(Ja, {}) })
            }
          )
        ]
      }
