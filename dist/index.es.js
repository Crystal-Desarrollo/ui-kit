...
import Dt, { useId as os, useState as $e, useEffect as Gt, Children as as, isValidElement as Kr, cloneElement as Jr, createElement as is, useRef as Zn, Suspense as ss } from "react";
import { CircularProgress as Ia, Paper as fn, Modal as ls, IconButton as rn, Typography as ze, Divider as eo, Stack as Ee, Button as nn, Avatar as cs, TableHead as us, TableRow as Yr, TableCell as Nr, TableSortLabel as ds, FormControl as Wr, FormControlLabel as Va, Switch as ps, TextField as Ha, InputLabel as fs, Select as ms, MenuItem as gs, createTheme as hs, ThemeProvider as La, TableContainer as Fa, Table as Za, TableBody as qa, TablePagination as ka, Checkbox as bs, Tab as vs, Slide as ys, Link as ws, Drawer as Ua, useMediaQuery as Ds, Toolbar as on, AppBar as As, Popper as Os, Grow as xs, ButtonBase as Cs, Box as an, Container as Ms } from "@mui/material";
import { Close as Ys, Report as Sa, Logout as Ns, Menu as Ts } from "@mui/icons-material";
...
function Hs() {
  if (zo)
    return gr;
  zo = 1;
  var e = Dt, t = Symbol.for("react.element"), r = Symbol.for("react.fragment"), n = Object.prototype.hasOwnProperty, o = e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, i = { key: !0, ref: !0, __self: !0, __source: !0 };
  function s(l, c, u) {
...
function Ls() {
  return Ro || (Ro = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Dt, t = Symbol.for("react.element"), r = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), o = Symbol.for("react.strict_mode"), i = Symbol.for("react.profiler"), s = Symbol.for("react.provider"), l = Symbol.for("react.context"), c = Symbol.for("react.forward_ref"), u = Symbol.for("react.suspense"), d = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), m = Symbol.for("react.lazy"), b = Symbol.for("react.offscreen"), A = Symbol.iterator, g = "@@iterator";
    function v(p) {
    ...
    var C = !1, D = !1, G = !1, j = !1, R = !1, H;
    H = Symbol.for("react.module.reference");
    function N(p) {
      return !!(typeof p == "string" || typeof p == "function" || p === n || p === i || R || p === o || p === u || p === d || j || p === b || C || D || G || typeof p == "object" && p !== null && (p.$$typeof === m || p.$$typeof === f || p.$$typeof === s || p.$$typeof === l || p.$$typeof === c || // This needs to include all possible module reference object
    ...
    function $(p) {
      ...
      if (typeof p == "object")
        switch (p.$$typeof) {
          ...
          case m: {
            var w = p, O = w._payload, E = w._init;
            try {
              return $(E(O));
            } catch {
              return null;
    ...
    var ne = Object.assign, se = 0, re, ce, le, pe, T, L, te;
    function Q() {
    }
    ...
    function Z() {
      {
        if (se === 0) {
          re = console.log, ce = console.info, le = console.warn, pe = console.error, T = console.group, L = console.groupCollapsed, te = console.groupEnd;
          var p = {
            configurable: !0,
            enumerable: !0,
            value: Q,
...
` + q[de].replace(" at new ", " at ");
    ...
    function Ie(p, B, V, y, w) {
      {
        ...
        for (var E in p)
          if (O(p, E)) {
            var q = void 0;
            try {
              if (typeof p[E] != "function") {
                var ue = Error((y || "React class") + ": " + V + " type `" + E + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof p[E] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw ue.name = "Invariant Violation", ue;
              }
              q = p[E](B, E, y, V, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (de) {
              q = de;
            }
            q && !(q instanceof Error) && (Re(w), W("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", y || "React class", V, E, typeof q), Re(null)), q instanceof Error && !(q.message in me) && (me[q.message] = !0, Re(w), W("Failed %s type: %s", V, q.message), Re(null));
          }
      }
    }
    ...
    function gt(p, B, V, y, w) {
      {
        var O, E = {}, q = null, ue = null;
        V !== void 0 && (at(V), q = "" + V), ke(B) && (at(B.key), q = "" + B.key), Pt(B) && (ue = B.ref, Xe(B, w));
        for (O in B)
          We.call(B, O) && !xe.hasOwnProperty(O) && (E[O] = B[O]);
        if (p && p.defaultProps) {
        ...
        if (q || ue) {
          ...
          q && dr(E, he), ue && vt(E, he);
        }
        return pr(p, q, ue, w, y, Me.current, E);
      }
    }
    ...
    function Et(p, B) {
      {
        ...
        if (Ve(p))
          ...
          if (typeof w == "function" && w !== p.entries)
            for (var O = w.call(p), E; !(E = O.next()).done; )
              zt(E.value) && Ut(E.value, B);
        }
      }
    }
    function He(p) {
    ...
    function Je(p, B, V, y, w, O) {
      {
        ...
        if (!E) {
          ...
          ue ? q += ue : q += Bt();
          var de;
          p === null ? de = "null" : Ve(p) ? de = "array" : p !== void 0 && p.$$typeof === t ? (de = "<" + ($(p.type) || "Unknown") + " />", q = " Did you accidentally export a JSX literal instead of a component?") : de = typeof p, W("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", de, q);
        }
        var he = gt(p, B, V, w, O);
        if (he == null)
          return he;
...
var ro = qn.exports;
const ur = ro.Fragment, h = ro.jsx, oe = ro.jsxs, Fs = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  Fragment: ur,
  jsx: h,
  jsxs: oe
...
function Zs() {
  if (Io)
    return ve;
  Io = 1;
  var e = typeof Symbol == "function" && Symbol.for, t = e ? Symbol.for("react.element") : 60103, r = e ? Symbol.for("react.portal") : 60106, n = e ? Symbol.for("react.fragment") : 60107, o = e ? Symbol.for("react.strict_mode") : 60108, i = e ? Symbol.for("react.profiler") : 60114, s = e ? Symbol.for("react.provider") : 60109, l = e ? Symbol.for("react.context") : 60110, c = e ? Symbol.for("react.async_mode") : 60111, u = e ? Symbol.for("react.concurrent_mode") : 60111, d = e ? Symbol.for("react.forward_ref") : 60112, f = e ? Symbol.for("react.suspense") : 60113, m = e ? Symbol.for("react.suspense_list") : 60120, b = e ? Symbol.for("react.memo") : 60115, A = e ? Symbol.for("react.lazy") : 60116, g = e ? Symbol.for("react.block") : 60121, v = e ? Symbol.for("react.fundamental") : 60117, P = e ? Symbol.for("react.responder") : 60118, W = e ? Symbol.for("react.scope") : 60119;
  function M(D) {
  ...
  return ve.AsyncMode = c, ve.ConcurrentMode = u, ve.ContextConsumer = l, ve.ContextProvider = s, ve.Element = t, ve.ForwardRef = d, ve.Fragment = n, ve.Lazy = A, ve.Memo = b, ve.Portal = r, ve.Profiler = i, ve.StrictMode = o, ve.Suspense = f, ve.isAsyncMode = function(D) {
    ...
    return typeof D == "string" || typeof D == "function" || D === n || D === u || D === i || D === o || D === f || D === m || typeof D == "object" && D !== null && (D.$$typeof === A || D.$$typeof === b || D.$$typeof === s || D.$$typeof === l || D.$$typeof === d || D.$$typeof === v || D.$$typeof === P || D.$$typeof === W || D.$$typeof === g);
  }, ve.typeOf = M, ve;
}
var ye = {};
/** @license React v16.13.1
...
function qs() {
  return Vo || (Vo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function M(z) {
      ...
      z === n || z === u || z === i || z === o || z === f || z === m || typeof z == "object" && z !== null && (z.$$typeof === A || z.$$typeof === b || z.$$typeof === s || z.$$typeof === l || z.$$typeof === d || z.$$typeof === v || z.$$typeof === P || z.$$typeof === W || z.$$typeof === g);
    }
    function C(z) {
    ...
    var D = c, G = u, j = l, R = s, H = t, N = d, I = n, ae = A, $ = b, ne = r, se = i, re = o, ce = f, le = !1;
    function pe(z) {
      return le || (le = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), T(z) || C(z) === c;
    }
    function T(z) {
      return C(z) === u;
    }
    ...
    ye.AsyncMode = D, ye.ConcurrentMode = G, ye.ContextConsumer = j, ye.ContextProvider = R, ye.Element = H, ye.ForwardRef = N, ye.Fragment = I, ye.Lazy = ae, ye.Memo = $, ye.Portal = ne, ye.Profiler = se, ye.StrictMode = re, ye.Suspense = ce, ye.isAsyncMode = pe, ye.isConcurrentMode = T, ye.isContextConsumer = L, ye.isContextProvider = te, ye.isElement = Q, ye.isForwardRef = Z, ye.isFragment = _, ye.isLazy = X, ye.isMemo = k, ye.isPortal = U, ye.isProfiler = ee, ye.isStrictMode = ie, ye.isSuspense = fe, ye.isValidElementType = M, ye.typeOf = C;
  }()), ye;
}
var Ho;
function $a() {
  ...
  return jn = function(l, c) {
    ...
    function v(T) {
      ...
      function Q(_, X, k, U, ee, ie, fe) {
        ...
        return X[k] == null ? _ ? X[k] === null ? new g("The " + ee + " `" + ie + "` is marked as required " + ("in `" + U + "`, but its value is `null`.")) : new g("The " + ee + " `" + ie + "` is marked as required in " + ("`" + U + "`, but its value is `undefined`.")) : null : T(X, k, U, ee, ie);
      }
      var Z = Q.bind(null, !1);
    ...
    function P(T) {
      function L(te, Q, Z, _, X, k) {
        ...
        if (ee !== T) {
          var ie = ce(U);
          return new g(
            "Invalid " + _ + " `" + X + "` of type " + ("`" + ie + "` supplied to `" + Z + "`, expected ") + ("`" + T + "`."),
            { expectedType: T }
          );
        }
        return null;
    ...
    function M(T) {
      function L(te, Q, Z, _, X) {
        if (typeof T != "function")
          return new g("Property `" + X + "` of component `" + Z + "` has invalid PropType notation inside arrayOf.");
        var k = te[Q];
        if (!Array.isArray(k)) {
          var U = re(k);
          return new g("Invalid " + _ + " `" + X + "` of type " + ("`" + U + "` supplied to `" + Z + "`, expected an array."));
        }
        for (var ee = 0; ee < k.length; ee++) {
          var ie = T(k, ee, Z, _, X + "[" + ee + "]", r);
    ...
    function C() {
      function T(L, te, Q, Z, _) {
        var X = L[te];
        if (!l(X)) {
          var k = re(X);
          return new g("Invalid " + Z + " `" + _ + "` of type " + ("`" + k + "` supplied to `" + Q + "`, expected a single ReactElement."));
        }
        return null;
      }
      return v(T);
    ...
    function D() {
      function T(L, te, Q, Z, _) {
        ...
        if (!e.isValidElementType(X)) {
          var k = re(X);
          return new g("Invalid " + Z + " `" + _ + "` of type " + ("`" + k + "` supplied to `" + Q + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return v(T);
    ...
    function G(T) {
      function L(te, Q, Z, _, X) {
        if (!(te[Q] instanceof T)) {
          var k = T.name || m, U = pe(te[Q]);
          return new g("Invalid " + _ + " `" + X + "` of type " + ("`" + U + "` supplied to `" + Z + "`, expected ") + ("instance of `" + k + "`."));
        }
        return null;
      }
      return v(L);
    ...
    function j(T) {
      ...
      function L(te, Q, Z, _, X) {
        for (var k = te[Q], U = 0; U < T.length; U++)
          if (A(k, T[U]))
            return null;
        var ee = JSON.stringify(T, function(fe, z) {
          var Ne = ce(z);
          return Ne === "symbol" ? String(z) : z;
        });
        return new g("Invalid " + _ + " `" + X + "` of value `" + String(k) + "` " + ("supplied to `" + Z + "`, expected one of " + ee + "."));
      }
      return v(L);
    }
    function R(T) {
      function L(te, Q, Z, _, X) {
        if (typeof T != "function")
          return new g("Property `" + X + "` of component `" + Z + "` has invalid PropType notation inside objectOf.");
        var k = te[Q], U = re(k);
        if (U !== "object")
          return new g("Invalid " + _ + " `" + X + "` of type " + ("`" + U + "` supplied to `" + Z + "`, expected an object."));
        for (var ee in k)
          if (n(k, ee)) {
            var ie = T(k, ee, Z, _, X + "." + ee, r);
            if (ie instanceof Error)
    ...
    function H(T) {
      ...
      function Q(Z, _, X, k, U) {
        for (var ee = [], ie = 0; ie < T.length; ie++) {
          var fe = T[ie], z = fe(Z, _, X, k, U, r);
          if (z == null)
            return null;
          z.data && n(z.data, "expectedType") && ee.push(z.data.expectedType);
        }
        var Ne = ee.length > 0 ? ", expected one of type [" + ee.join(", ") + "]" : "";
        return new g("Invalid " + k + " `" + U + "` supplied to " + ("`" + X + "`" + Ne + "."));
      }
      return v(Q);
    }
    function N() {
      function T(L, te, Q, Z, _) {
        return ne(L[te]) ? null : new g("Invalid " + Z + " `" + _ + "` supplied to " + ("`" + Q + "`, expected a ReactNode."));
      }
      return v(T);
    }
    function I(T, L, te, Q, Z) {
      return new g(
        (T || "React class") + ": " + L + " type `" + te + "." + Q + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + Z + "`."
      );
    }
    function ae(T) {
      function L(te, Q, Z, _, X) {
        var k = te[Q], U = re(k);
        if (U !== "object")
          return new g("Invalid " + _ + " `" + X + "` of type `" + U + "` " + ("supplied to `" + Z + "`, expected `object`."));
        for (var ee in T) {
          var ie = T[ee];
          if (typeof ie != "function")
            return I(Z, _, X, ee, ce(ie));
    ...
    function $(T) {
      function L(te, Q, Z, _, X) {
        ...
        for (var ie in ee) {
          var fe = T[ie];
          if (n(T, ie) && typeof fe != "function")
            return I(Z, _, X, ie, ce(fe));
          if (!fe)
            return new g(
...
Valid keys: ` + JSON.stringify(Object.keys(T), null, "  ")
    ...
    function re(T) {
      var L = typeof T;
      return Array.isArray(T) ? "array" : T instanceof RegExp ? "object" : se(L, T) ? "symbol" : L;
    }
    function ce(T) {
...
if (process.env.NODE_ENV !== "production") {
  ...
  kn.exports = Qs()();
var Js = kn.exports;
const a = /* @__PURE__ */ Vs(Js), Zt = Dt.forwardRef(
  (e, t) => {
    const { size: r } = e;
    return /* @__PURE__ */ h(
      "div",
...
const $s = ({
  ...
  return /* @__PURE__ */ h(
    ls,
    {
      ...
      ...s,
      children: /* @__PURE__ */ oe(ur, { children: [
        i && /* @__PURE__ */ h(Zt, {}),
        /* @__PURE__ */ oe($s, { sx: n, children: [
          /* @__PURE__ */ h(
            rn,
            {
              onClick: l,
...
const ei = ({
  ...
  return /* @__PURE__ */ oe(
    oo,
    {
      ...
      children: [
        i && /* @__PURE__ */ h(Zt, {}),
        /* @__PURE__ */ h(ze, { fontWeight: "bold", variant: "h6", mb: 1, children: /* @__PURE__ */ h("strong", { children: t ?? "" }) }),
        /* @__PURE__ */ h(eo, { sx: { mb: 2 } }),
        /* @__PURE__ */ h(Ee, { mb: 1, fontSize: 16, textAlign: "center", children: r ?? "" }),
        /* @__PURE__ */ oe(Ee, { direction: "column", mb: 2, children: [
          l,
          s && /* @__PURE__ */ oe(Ee, { alignItems: "center", direction: "row", mt: 1, children: [
            /* @__PURE__ */ h(
              Sa,
              {
                color: "error",
            ...
            /* @__PURE__ */ h(ze, { color: "error", fontSize: "16px", children: typeof s == "string" ? s : "Ocurrió un error, intente nuevamente." })
          ] })
        ] }),
        /* @__PURE__ */ oe(Ee, { direction: "row", justifyContent: "end", children: [
          /* @__PURE__ */ h(
            nn,
            {
              variant: "outlined",
          ...
          /* @__PURE__ */ h(nn, { onClick: u, disabled: i, children: s ? "Reintentar" : "Confirmar" })
        ] })
      ]
    }
  );
...
function _s(e) {
  ...
  return /* @__PURE__ */ h(ur, { children: r === n && t });
}
_s.propTypes = {
  index: a.number,
  value: a.any,
...
const ao = (e) => {
  ...
  return /* @__PURE__ */ h(us, { sx: { backgroundColor: (s) => s.palette.table.header }, children: /* @__PURE__ */ h(Yr, { children: n.map((s) => /* @__PURE__ */ h(Nr, { component: "th", children: s.isSortable ? /* @__PURE__ */ h(
    ds,
    {
      active: t === s.id,
...
const el = ({
  ...
  const { control: i } = zr();
  return /* @__PURE__ */ h(Wr, { children: /* @__PURE__ */ h(
    Rr,
    {
      control: i,
      name: t,
...
const tl = ({
  ...
  const { control: f } = zr();
  return /* @__PURE__ */ h(Wr, { fullWidth: n, ...d, children: /* @__PURE__ */ h(
    Rr,
    {
      control: f,
      name: e,
      render: ({ field: { onChange: m, onBlur: b, value: A, name: g, ref: v } }) => /* @__PURE__ */ h(
        Ha,
        {
          helperText: u,
          multiline: l,
...
const rl = ({ open: e, onConfirm: t, children: r }) => {
  ...
  return /* @__PURE__ */ oe(
    oo,
    {
      ...
      children: [
        /* @__PURE__ */ h(ze, { fontWeight: "bold", variant: "h6", mb: 1, color: "error", children: "Error" }),
        /* @__PURE__ */ h(eo, { sx: { mb: 2 } }),
        /* @__PURE__ */ h(Ee, { direction: "column", mb: 2, children: r && /* @__PURE__ */ oe(Ee, { alignItems: "center", children: [
          /* @__PURE__ */ h(Sa, { color: "error", sx: { mb: "1rem", fontSize: "3rem" } }),
          /* @__PURE__ */ h(ze, { color: "error", fontSize: "16px", textAlign: "center", children: r })
        ] }) }),
        /* @__PURE__ */ h(Ee, { direction: "row", justifyContent: "end", children: /* @__PURE__ */ h(nn, { onClick: n, children: "Aceptar" }) })
      ]
    }
  );
};
...
function nl({ money: e, ...t }) {
  return /* @__PURE__ */ h(ze, { component: "span", fontSize: 14, ...t, children: Number(e).toLocaleString("es-AR", {
    style: "currency",
    currency: "ARS"
  }) });
}
...
const ol = ({ title: e, renderAside: t }) => /* @__PURE__ */ oe(
  Ee,
  {
    display: "flex",
    direction: "row",
    ...
    marginBottom: 2,
    children: [
      /* @__PURE__ */ h(ze, { fontWeight: "bold", fontSize: 24, children: e }),
      t && /* @__PURE__ */ h(Ee, { children: t })
    ]
  }
);
ol.propTypes = {
...
const ti = ({
  ...
  const l = os(), c = i || al, { control: u } = zr();
  return /* @__PURE__ */ oe(Wr, { fullWidth: !0, children: [
    /* @__PURE__ */ h(fs, { id: l, required: n, disabled: o, children: r }),
    /* @__PURE__ */ h(
      Rr,
      {
        control: u,
        name: t,
        render: ({ field: { onChange: d, onBlur: f, value: m, name: b, ref: A } }) => /* @__PURE__ */ h(
          ms,
          {
            required: n,
            labelId: l,
...
const sl = {
  ...
  const {
    ...
    row: c
  } = e, [u, d] = $e(l), [f, m] = $e(i), [b, A] = $e(0), [g, v] = $e(n), P = (G, j) => {
    const R = f === j && u === nt.ASC;
    d(R ? nt.DESC : nt.ASC), m(j);
  }, W = (G, j) => {
    A(j);
  }, M = (G) => {
    v(parseInt(G.target.value, 10)), A(0);
  }, D = (() => {
    const G = r.map((R, H) => [R, H]);
    return G.sort((R, H) => {
      const N = il(
        R[0],
        H[0],
      ...
      return N !== 0 ? N : R[1] - H[1];
    }), G.map((R) => R[0]).slice(
      b * g,
      b * g + g
    );
  })();
  return /* @__PURE__ */ oe(La, { theme: ri, children: [
    /* @__PURE__ */ h(Fa, { children: /* @__PURE__ */ oe(Za, { children: [
      /* @__PURE__ */ h(
        ao,
        {
          headCells: t,
      ...
      /* @__PURE__ */ oe(qa, { children: [
        o && /* @__PURE__ */ h(Yr, { children: /* @__PURE__ */ h(Nr, { colSpan: t.length, align: "center", children: /* @__PURE__ */ h(Zt, {}) }) }),
        (D == null ? void 0 : D.length) > 0 ? D.map((G) => Dt.cloneElement(c, { key: G.id, data: G })) : /* @__PURE__ */ h(Yr, { children: /* @__PURE__ */ h(Nr, { colSpan: t.length, align: "center", children: /* @__PURE__ */ h(ze, { variant: "h6", sx: { textAlign: "center" }, children: "No hay nada por aquí" }) }) })
      ] })
    ] }) }),
    /* @__PURE__ */ h(
      ka,
...
const Xl = Ql, Kl = ({ isoDateTimeString: e, relative: t = !1, showTime: r = !0 }) => {
  ...
  return t ? /* @__PURE__ */ h("span", { children: Es(n, /* @__PURE__ */ new Date(), {
    locale: Xl
  }) }) : /* @__PURE__ */ h("span", { children: Bs(n, o) });
};
Kl.propTypes = {
...
const $l = (e) => {
  ...
  const {
    ...
    baseParams: l,
    row: c
  } = e, [u, d] = Xa(), [f, m] = $e(o), [b, A] = $e(i), [g, v] = $e({
    ...Wo.parse(u.toString()),
    per_page: s
  }), {
    isLoading: P,
  ...
  const C = (H, N) => {
    ...
    v({ ...g, per_page: H.target.value, page: 1 });
  };
  return /* @__PURE__ */ oe(ur, { children: [
    /* @__PURE__ */ h(Fa, { sx: { position: "relative" }, children: /* @__PURE__ */ oe(Za, { children: [
      /* @__PURE__ */ h(
        ao,
        {
          headCells: t,
          orderBy: f,
          orderDirection: b,
          handleSortRequest: (H, N) => {
            m(N), A(
              f === N && b === nt.ASC ? nt.DESC : nt.ASC
            );
          }
        }
      ),
      /* @__PURE__ */ oe(qa, { children: [
        (P || W) && // 475px is approximately the size of the box with the default of 10 rows per page
        // We need to force this min height so the box doesn't become small when loading
        /* @__PURE__ */ h(Yr, { sx: { minHeight: "475px" }, children: /* @__PURE__ */ h(Nr, { colSpan: t.length, align: "center", children: /* @__PURE__ */ h(Zt, {}) }) }),
        ((j = M == null ? void 0 : M.data) == null ? void 0 : j.length) > 0 && M.data.map((H) => Dt.cloneElement(c, { key: H.id, data: H })),
        !P && !W && ((R = M == null ? void 0 : M.data) == null ? void 0 : R.length) === 0 && /* @__PURE__ */ h(Yr, { children: /* @__PURE__ */ h(Nr, { colSpan: t.length, align: "center", children: /* @__PURE__ */ h(ze, { variant: "h6", sx: { textAlign: "center" }, children: "No hay nada por aquí" }) }) })
      ] })
    ] }) }),
    M && /* @__PURE__ */ h(
      ka,
...
function ac() {
  return Qo || (Qo = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), r = Symbol.for("react.fragment"), n = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), i = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), u = Symbol.for("react.suspense"), d = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), m = Symbol.for("react.lazy"), b = Symbol.for("react.offscreen"), A = !1, g = !1, v = !1, P = !1, W = !1, M;
    M = Symbol.for("react.module.reference");
    function C(F) {
      return !!(typeof F == "string" || typeof F == "function" || F === r || F === o || W || F === n || F === u || F === d || P || F === b || A || g || v || typeof F == "object" && F !== null && (F.$$typeof === m || F.$$typeof === f || F.$$typeof === i || F.$$typeof === s || F.$$typeof === c || // This needs to include all possible module reference object
      // types supported by any Flight configuration anywhere since
      // we don't know which Flight build this will end up being used
      // with.
    ...
    var G = s, j = i, R = e, H = c, N = r, I = m, ae = f, $ = t, ne = o, se = n, re = u, ce = d, le = !1, pe = !1;
    function T(F) {
    ...
    De.ContextConsumer = G, De.ContextProvider = j, De.Element = R, De.ForwardRef = H, De.Fragment = N, De.Lazy = I, De.Memo = ae, De.Portal = $, De.Profiler = ne, De.StrictMode = se, De.Suspense = re, De.SuspenseList = ce, De.isAsyncMode = T, De.isConcurrentMode = L, De.isContextConsumer = te, De.isContextProvider = Q, De.isElement = Z, De.isForwardRef = _, De.isFragment = X, De.isLazy = k, De.isMemo = U, De.isPortal = ee, De.isProfiler = ie, De.isStrictMode = fe, De.isSuspense = z, De.isSuspenseList = Ne, De.isValidElementType = C, De.typeOf = D;
  }()), De;
}
...
function Ic(e) {
  ...
  if (!t) {
    const b = Ae(o == null ? void 0 : o.className, n == null ? void 0 : n.className, i, r == null ? void 0 : r.className), A = x({}, r == null ? void 0 : r.style, o == null ? void 0 : o.style, n == null ? void 0 : n.style), g = x({}, r, o, n);
    return b.length > 0 && (g.className = b), Object.keys(A).length > 0 && (g.style = A), {
      props: g,
      internalRef: void 0
    };
  }
...
var _e = "top", ct = "bottom", ut = "right", et = "left", lo = "auto", Ir = [_e, ct, ut, et], ir = "start", Br = "end", Lc = "clippingParents", mi = "viewport", yr = "popper", Fc = "reference", ra = /* @__PURE__ */ Ir.reduce(function(e, t) {
...
function nu(e) {
  ...
  var o = gn(e);
  for (co(o) && (o = o.host); lt(o) && ["html", "body"].indexOf(Ot(o)) < 0; ) {
    var i = Tt(o);
...
function Vr(e) {
  for (var t = ot(e), r = na(e); r && ru(r) && Tt(r).position === "static"; )
    r = na(r);
  return r && (Ot(r) === "html" || Ot(r) === "body" && Tt(r).position === "static") ? t : r || nu(e) || t;
}
function po(e) {
...
function iu(e) {
  var t, r = e.state, n = e.name, o = e.options, i = r.elements.arrow, s = r.modifiersData.popperOffsets, l = At(r.placement), c = po(l), u = [et, ut].indexOf(l) >= 0, d = u ? "height" : "width";
  if (!(!i || !s)) {
    var f = au(o.padding, r), m = uo(i), b = c === "y" ? _e : et, A = c === "y" ? ct : ut, g = r.rects.reference[d] + r.rects.reference[c] - s[c] - r.rects.popper[d], v = s[c] - r.rects.reference[c], P = Vr(i), W = P ? c === "y" ? P.clientHeight || 0 : P.clientWidth || 0 : 0, M = g / 2 - v / 2, C = f[b], D = W - m[d] - f[A], G = W / 2 - m[d] / 2 + M, j = Or(C, G, D), R = c;
    r.modifiersData[n] = (t = {}, t[R] = j, t.centerOffset = j - G, t);
  }
}
function su(e) {
...
function oa(e) {
  var t, r = e.popper, n = e.popperRect, o = e.placement, i = e.variation, s = e.offsets, l = e.position, c = e.gpuAcceleration, u = e.adaptive, d = e.roundOffsets, f = e.isFixed, m = s.x, b = m === void 0 ? 0 : m, A = s.y, g = A === void 0 ? 0 : A, v = typeof d == "function" ? d({
    x: b,
    y: g
  }) : {
    x: b,
  ...
  b = v.x, g = v.y;
  var P = s.hasOwnProperty("x"), W = s.hasOwnProperty("y"), M = et, C = _e, D = window;
  if (u) {
    var G = Vr(r), j = "clientHeight", R = "clientWidth";
    if (G === ot(r) && (G = jt(r), Tt(G).position !== "static" && l === "absolute" && (j = "scrollHeight", R = "scrollWidth")), G = G, o === _e || (o === et || o === ut) && i === Br) {
      C = ct;
      var H = f && G === D && D.visualViewport ? D.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        G[j]
      );
      g -= H - n.height, g *= c ? 1 : -1;
    }
    if (o === et || (o === _e || o === ct) && i === Br) {
      M = ut;
  ...
  if (b = ae.x, g = ae.y, c) {
    var $;
    return Object.assign({}, I, ($ = {}, $[C] = W ? "0" : "", $[M] = P ? "0" : "", $.transform = (D.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + g + "px)" : "translate3d(" + b + "px, " + g + "px, 0)", $));
  }
  return Object.assign({}, I, (t = {}, t[C] = W ? g + "px" : "", t[M] = P ? b + "px" : "", t.transform = "", t));
}
function du(e) {
...
function Di(e) {
  return ["html", "body", "#document"].indexOf(Ot(e)) >= 0 ? e.ownerDocument.body : lt(e) && go(e) ? e : Di(gn(e));
}
function xr(e, t) {
  var r;
  t === void 0 && (t = []);
...
function wu(e) {
  var t = xr(gn(e)), r = ["absolute", "fixed"].indexOf(Tt(e).position) >= 0, n = r && lt(e) ? Vr(e) : e;
  return Lt(n) ? t.filter(function(o) {
    return Lt(o) && bi(o, n) && Ot(o) !== "body";
  }) : [];
}
function Du(e, t, r, n) {
...
function Er(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = n === void 0 ? e.placement : n, i = r.strategy, s = i === void 0 ? e.strategy : i, l = r.boundary, c = l === void 0 ? Lc : l, u = r.rootBoundary, d = u === void 0 ? mi : u, f = r.elementContext, m = f === void 0 ? yr : f, b = r.altBoundary, A = b === void 0 ? !1 : b, g = r.padding, v = g === void 0 ? 0 : g, P = yi(typeof v != "number" ? v : wi(v, Ir)), W = m === yr ? Fc : yr, M = e.rects.popper, C = e.elements[A ? W : m], D = Du(Lt(C) ? C : C.contextElement || jt(e.elements.popper), c, d, s), G = lr(e.elements.reference), j = Ai({
    reference: G,
    element: M,
    strategy: "absolute",
    placement: o
  }), R = $n(Object.assign({}, M, j)), H = m === yr ? R : G, N = {
    top: D.top - H.top + P.top,
    bottom: H.bottom - D.bottom + P.bottom,
    left: D.left - H.left + P.left,
    right: H.right - D.right + P.right
...
function Au(e, t) {
  ...
  return Object.keys(b).sort(function(A, g) {
    return b[A] - b[g];
  });
}
function Ou(e) {
...
function xu(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var o = r.mainAxis, i = o === void 0 ? !0 : o, s = r.altAxis, l = s === void 0 ? !0 : s, c = r.fallbackPlacements, u = r.padding, d = r.boundary, f = r.rootBoundary, m = r.altBoundary, b = r.flipVariations, A = b === void 0 ? !0 : b, g = r.allowedAutoPlacements, v = t.options.placement, P = At(v), W = P === v, M = c || (W || !A ? [_r(v)] : Ou(v)), C = [v].concat(M).reduce(function(Z, _) {
      return Z.concat(At(_) === lo ? Au(t, {
        placement: _,
        boundary: d,
        rootBoundary: f,
        padding: u,
    ...
    }, []), D = t.rects.reference, G = t.rects.popper, j = /* @__PURE__ */ new Map(), R = !0, H = C[0], N = 0; N < C.length; N++) {
      var I = C[N], ae = At(I), $ = cr(I) === ir, ne = [_e, ct].indexOf(ae) >= 0, se = ne ? "width" : "height", re = Er(t, {
        placement: I,
        boundary: d,
        rootBoundary: f,
        altBoundary: m,
      ...
      D[se] > G[se] && (ce = _r(ce));
      var le = _r(ce), pe = [];
      if (i && pe.push(re[ae] <= 0), l && pe.push(re[ce] <= 0, re[le] <= 0), pe.every(function(Z) {
        return Z;
      })) {
        H = I, R = !1;
        break;
...
function Nu(e, t, r) {
  var n = At(e), o = [et, _e].indexOf(n) >= 0 ? -1 : 1, i = typeof r == "function" ? r(Object.assign({}, t, {
    placement: e
  })) : r, s = i[0], l = i[1];
...
function ju(e) {
  var t = e.state, r = e.options, n = e.name, o = r.mainAxis, i = o === void 0 ? !0 : o, s = r.altAxis, l = s === void 0 ? !1 : s, c = r.boundary, u = r.rootBoundary, d = r.altBoundary, f = r.padding, m = r.tether, b = m === void 0 ? !0 : m, A = r.tetherOffset, g = A === void 0 ? 0 : A, v = Er(t, {
    boundary: c,
    rootBoundary: u,
    padding: f,
    altBoundary: d
  }), P = At(t.placement), W = cr(t.placement), M = !W, C = po(P), D = Gu(C), G = t.modifiersData.popperOffsets, j = t.rects.reference, R = t.rects.popper, H = typeof g == "function" ? g(Object.assign({}, t.rects, {
    placement: t.placement
  })) : g, N = typeof H == "number" ? {
    mainAxis: H,
    altAxis: H
    ...
    mainAxis: 0,
    altAxis: 0
  }, H), I = t.modifiersData.offset ? t.modifiersData.offset[t.placement] : null, ae = {
    x: 0,
    y: 0
  };
  if (G) {
    if (i) {
      var $, ne = C === "y" ? _e : et, se = C === "y" ? ct : ut, re = C === "y" ? "height" : "width", ce = G[C], le = ce + v[ne], pe = ce - v[se], T = b ? -R[re] / 2 : 0, L = W === ir ? j[re] : R[re], te = W === ir ? -R[re] : -j[re], Q = t.elements.arrow, Z = b && Q ? uo(Q) : {
        width: 0,
        height: 0
      }, _ = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : vi(), X = _[ne], k = _[se], U = Or(0, j[re], Z[re]), ee = M ? j[re] / 2 - T - U - X - N.mainAxis : L - U - X - N.mainAxis, ie = M ? -j[re] / 2 + T + U + k + N.mainAxis : te + U + k + N.mainAxis, fe = t.elements.arrow && Vr(t.elements.arrow), z = fe ? C === "y" ? fe.clientTop || 0 : fe.clientLeft || 0 : 0, Ne = ($ = I == null ? void 0 : I[C]) != null ? $ : 0, F = ce + ee - Ne - z, S = ce + ie - Ne, We = Or(b ? ln(le, F) : le, ce, b ? Ht(pe, S) : pe);
      G[C] = We, ae[C] = We - ce;
    }
    if (l) {
      var me, qe = C === "x" ? _e : et, Re = C === "x" ? ct : ut, Ie = G[D], Le = D === "y" ? "height" : "width", Ve = Ie + v[qe], ft = Ie - v[Re], Qe = [_e, et].indexOf(P) !== -1, Ze = (me = I == null ? void 0 : I[D]) != null ? me : 0, at = Qe ? Ve : Ie - j[Le] - R[Le] - Ze + N.altAxis, Me = Qe ? Ie + j[Le] + R[Le] - Ze - N.altAxis : ft, xe = b && Qe ? ou(at, Ie, Me) : Or(b ? at : Ve, Ie, b ? Me : ft);
      G[D] = xe, ae[D] = xe - Ie;
    }
  ...
  return function(l, c, u) {
    ...
    var d = {
      ...
      setOptions: function(P) {
        var W = typeof P == "function" ? P(d.options) : P;
        g(), d.options = Object.assign({}, i, d.options, W), d.scrollParents = {
      ...
      forceUpdate: function() {
        if (!m) {
          var P = d.elements, W = P.reference, M = P.popper;
          if (ua(W, M)) {
            d.rects = {
            ...
            for (var C = 0; C < d.orderedModifiers.length; C++) {
              ...
              var D = d.orderedModifiers[C], G = D.fn, j = D.options, R = j === void 0 ? {} : j, H = D.name;
    ...
    function A() {
      d.orderedModifiers.forEach(function(v) {
        var P = v.name, W = v.options, M = W === void 0 ? {} : W, C = v.effect;
...
const cn = /* @__PURE__ */ Y.forwardRef(function(t, r) {
  const {
    ...
    container: o,
    disablePortal: i = !1
  } = t, [s, l] = Y.useState(null), c = Nt(/* @__PURE__ */ Y.isValidElement(n) ? n.ref : null, r);
  if (ar(() => {
...
const _u = () => xt({
  ...
  } = t, v = Ye(t, Xu), P = Y.useRef(null), W = Nt(P, r), M = Y.useRef(null), C = Nt(M, m), D = Y.useRef(C);
  ar(() => {
    D.current = C;
  }, [C]), Y.useImperativeHandle(m, () => M.current, []);
  const G = Ju(d, s), [j, R] = Y.useState(G), [H, N] = Y.useState(un(o));
  Y.useEffect(() => {
    ...
    if (process.env.NODE_ENV !== "production" && H && hn(H) && H.nodeType === 1) {
...
`));
  ...
  const ae = _u(), $ = (n = A.root) != null ? n : "div", ne = Hc({
    elementType: $,
  ...
  if (i)
    ...
    const N = un(n);
    j = N && hn(N) ? sn(N).body : sn(null).body;
  }
  const R = !d && c && (!g || M) ? "none" : void 0, H = g ? {
    in: d,
    onEnter: D,
    onExited: G
  } : void 0;
...
function od(e) {
  ...
  const _ = Y.useRef(!1), X = Y.useRef(!0), k = Y.useRef(null), U = Y.useRef(null), [ee, ie] = Y.useState(null), [fe, z] = Y.useState(-1), Ne = o ? 0 : -1, F = Y.useRef(Ne), [S, We] = $r({
    controlled: te,
    default: d,
    name: u
  }), [me, qe] = $r({
    ...
    me !== E && (qe(E), se && se(y, E, "reset"));
  }, [Z, me, I, se, qe, l, S]), [Ve, ft] = $r({
    controlled: ce,
    default: !1,
    name: u,
    state: "open"
  }), [Qe, Ze] = Y.useState(!0), at = !I && S != null && me === Z(S), Me = Ve && !T, xe = Me ? v(
    pe.filter((y) => !(P && (I ? S : [S]).some((w) => w !== null && N(y, w)))),
  ...
  const mt = Ve && xe.length > 0 && !T;
  if (process.env.NODE_ENV !== "production" && S !== null && !W && pe.length > 0) {
    const y = (I ? S : [S]).filter((w) => !pe.some((O) => N(O, w)));
...
`));
  ...
  function Pt(y, w) {
    ...
    for (; ; ) {
      if (w === "next" && O === xe.length || w === "previous" && O === -1)
        return -1;
      const E = U.current.querySelector(`[data-option-index="${O}"]`), q = A ? !1 : !E || E.disabled || E.getAttribute("aria-disabled") === "true";
      if (E && !E.hasAttribute("tabindex") || q)
        O += w === "next" ? 1 : -1;
      else
        return O;
    }
  ...
  const ke = Mt(({
    ...
    if (F.current = w, w === -1 ? k.current.removeAttribute("aria-activedescendant") : k.current.setAttribute("aria-activedescendant", `${Q}-option-${w}`), ne && ne(y, w === -1 ? null : xe[w], O), !U.current)
      return;
    const E = U.current.querySelector(`[role="option"].${r}-focused`);
    E && (E.classList.remove(`${r}-focused`), E.classList.remove(`${r}-focusVisible`));
    let q = U.current;
    ...
    const ue = Pt((() => {
      ...
      return he < 0 ? he === -1 && R ? -1 : g && F.current !== -1 || Math.abs(w) > 1 ? 0 : de : he > de ? he === de + 1 && R ? -1 : g || Math.abs(w) > 1 ? de : 0 : he;
    })(), O);
    if (ke({
      index: ue,
      reason: E,
    ...
    const y = (w, O) => {
      const E = w ? Z(w) : "", q = O ? Z(O) : "";
      return E === q;
    };
    if (F.current !== -1 && J.filteredOptions && J.filteredOptions.length !== xe.length && J.inputValue === me && (I ? S.length === J.value.length && J.value.every((w, O) => Z(S[O]) === Z(w)) : y(J.value, S))) {
      const w = J.filteredOptions[F.current];
      if (w && xe.some((E) => Z(E) === Z(w)))
        return !0;
    }
    return !1;
  }, vt = Y.useCallback(() => {
    ...
    if (U.current) {
      if (y != null) {
        ...
        if (I && w && In(S, (E) => N(w, E)) !== -1)
          return;
        const O = In(xe, (E) => N(E, y));
        O === -1 ? Xe({
          diff: "reset"
        }) : ke({
          index: O
...
`)));
  ...
  const gt = (y) => {
    ...
    if (I) {
      ...
      return;
    ae && ae(y, w, O, E), We(w);
  }, Ue = Y.useRef(!1), ht = (y, w, O = "selectOption", E = "options") => {
    let q = O, ue = w;
    if (I) {
      if (ue = Array.isArray(S) ? S.slice() : [], process.env.NODE_ENV !== "production") {
        const he = ue.filter((Fe) => N(w, Fe));
...
`));
      ...
      de === -1 ? ue.push(w) : E !== "freeSolo" && (ue.splice(de, 1), q = "removeOption");
    }
    Le(y, ue), tt(y, ue, q, {
      option: w
    }), !m && (!y || !y.ctrlKey && !y.metaKey) && Ke(y, q), (s === !0 || s === "touch" && Ue.current || s === "mouse" && !Ue.current) && k.current.blur();
  };
  function zt(y, w) {
    if (y === -1)
      return -1;
    ...
    for (; ; ) {
      if (w === "next" && O === S.length || w === "previous" && O === -1)
        return -1;
      const E = ee.querySelector(`[data-tag-index="${O}"]`);
      if (!E || !E.hasAttribute("tabindex") || E.disabled || E.getAttribute("aria-disabled") === "true")
        O += w === "next" ? 1 : -1;
      else
        return O;
    }
  ...
  const Bt = (y, w) => {
    ...
    me === "" && Ke(y, "toggleInput");
    let O = fe;
    fe === -1 ? me === "" && w === "previous" && (O = S.length - 1) : (O += w === "next" ? 1 : -1, O < 0 && (O = 0), O === S.length && (O = -1)), O = zt(O, w), z(O), it(O);
  }, qt = (y) => {
    _.current = !0, qe(""), se && se(y, "", "clear"), tt(y, I ? [] : null, "clear");
  }, kt = (y) => (w) => {
    if (y.onKeyDown && y.onKeyDown(w), !w.defaultMuiPrevented && (fe !== -1 && ["ArrowLeft", "ArrowRight"].indexOf(w.key) === -1 && (z(-1), it(-1)), w.which !== 229))
      switch (w.key) {
        case "Home":
          Me && G && (w.preventDefault(), Xe({
            diff: "start",
            direction: "next",
            reason: "keyboard",
            event: w
        ...
        case "Enter":
          if (F.current !== -1 && Me) {
            const O = xe[F.current], E = M ? M(O) : !1;
        ...
        case "Escape":
          ...
          break;
        case "Backspace":
          if (I && !T && me === "" && S.length > 0) {
            const O = fe === -1 ? S.length - 1 : fe, E = S.slice();
            E.splice(O, 1), tt(w, E, "removeOption", {
              option: S[O]
            });
          }
          break;
        case "Delete":
          if (I && !T && me === "" && S.length > 0 && fe !== -1) {
            const O = fe, E = S.slice();
            E.splice(O, 1), tt(w, E, "removeOption", {
              option: S[O]
            });
          }
  ...
  return b && Re && Ut(), {
    ...
    getOptionProps: ({
      ...
      const O = (I ? S : [S]).some((q) => q != null && N(w, q)), E = M ? M(w) : !1;
      return {
        key: Z(w),
        tabIndex: -1,
        role: "option",
...
Dn(xd, Cd, Md, Yd, Nd, Td, Pd, Bd, Ed, Gd, An);
const On = (e) => {
...
function tp() {
  function e(r, n, o, i) {
    ...
    return f ? f(s) : dt(s, n, (A) => {
      let g = dn(m, d, A);
      return A === g && typeof A == "string" && (g = dn(m, d, `${r}${A === "default" ? "" : K(A)}`, A)), c === !1 ? g : {
        [c]: g
      };
    });
  }
...
function bp(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, l = {}) => {
    ...
    let P = en;
    u === "Root" || u === "root" ? P = n : u ? P = o : dp(s) && (P = void 0);
    const W = ad(s, x({
      shouldForwardProp: P,
      label: v
    }, b)), M = (C, ...D) => {
      const G = D ? D.map((N) => typeof N == "function" && N.__emotion_real !== N ? (I) => N(x({}, I, {
        theme: wr(x({}, I, {
          defaultTheme: r,
          themeId: t
        }))
      ...
      c && m && G.push((N) => {
        ...
        if (ae) {
          const $ = {};
          return Object.entries(ae).forEach(([ne, se]) => {
            $[ne] = typeof se == "function" ? se(x({}, N, {
              theme: I
            })) : se;
          }), m(N, $);
        }
      ...
      if (process.env.NODE_ENV !== "production") {
        let N;
        c && (N = `${c}${K(u || "")}`), N === void 0 && (N = `Styled(${lc(s)})`), H.displayName = N;
      }
...
function Lp(e) {
  ...
  function f(g) {
    const v = va(g, Vn.text.primary) >= r ? Vn.text.primary : ya.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const P = va(g, v);
      P < 3 && console.error([`MUI: The contrast ratio of ${P}:1 for ${v} on ${g}`, "falls below the WCAG recommended absolute minimum contrast ratio of 3:1.", "https://www.w3.org/TR/2008/REC-WCAG20-20081211/#visual-audio-contrast-contrast"].join(`
`));
    }
    return v;
  }
  const m = ({
    ...
    if (g = x({}, g), !g.main && g[P] && (g.main = g[P]), !g.hasOwnProperty("main"))
      throw new Error(process.env.NODE_ENV !== "production" ? `MUI: The color${v ? ` (${v})` : ""} provided to augmentColor(color) is invalid.
The color object needs to have a \`main\` property or a \`${P}\` property.` : or(11, v ? ` (${v})` : "", P));
...
} });` : or(12, v ? ` (${v})` : "", JSON.stringify(g.main)));
    return wa(g, "light", W, n), wa(g, "dark", M, n), g.contrastText || (g.contrastText = f(g.main)), g;
  }, b = {
    dark: Vn,
    light: ya
  };
...
function qp(e, t) {
  ...
  const b = o / 14, A = f || ((P) => `${P / u * b}rem`), g = (P, W, M, C, D) => x({
    fontFamily: n,
    fontWeight: P,
    fontSize: A(W),
...
const Qp = ["none", Te(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), Te(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), Te(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), Te(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), Te(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), Te(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), Te(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), Te(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), Te(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), Te(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), Te(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), Te(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), Te(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), Te(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), Te(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), Te(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), Te(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), Te(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), Te(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), Te(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), Te(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), Te(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), Te(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), Te(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], Xp = Qp, Kp = ["duration", "easing", "delay"], Jp = {
...
function of(e = {}, ...t) {
  ...
  if (u = Yt(u, s), u = t.reduce((d, f) => Yt(d, f), u), process.env.NODE_ENV !== "production") {
    const d = ["active", "checked", "completed", "disabled", "error", "expanded", "focused", "focusVisible", "required", "selected"], f = (m, b) => {
      ...
      for (A in m) {
        const g = m[A];
        if (d.indexOf(A) !== -1 && Object.keys(g).length > 0) {
          if (process.env.NODE_ENV !== "production") {
            const v = pt("", A);
...
const Bi = (e) => en(e) && e !== "classes", sf = bp({
  ...
  const o = Ni(), i = bt({
    ...
    slots: M,
    slotProps: C
  } = i, D = Ye(i, cf), G = (n = M == null ? void 0 : M.root) != null ? n : c == null ? void 0 : c.Root, j = x({
    anchorEl: s,
    container: d,
    disablePortal: f,
    keepMounted: m,
...
const Ca = Dt.createContext(null);
function Co(e, t) {
  var r = function(i) {
    return t && Kr(i) ? t(i) : i;
...
var xf = Object.values || function(e) {
  ...
  return r.componentDidMount = function() {
    ...
    return delete l.appear, delete l.enter, delete l.exit, i === null ? /* @__PURE__ */ Dt.createElement(Ca.Provider, {
      value: c
    }, u) : /* @__PURE__ */ Dt.createElement(Ca.Provider, {
      value: c
    }, /* @__PURE__ */ Dt.createElement(i, l, u));
  }, t;
}(Dt.Component);
...
const Yf = Se("MuiTouchRipple", ["root", "ripple", "rippleVisible", "ripplePulsate", "child", "childLeaving", "childPulsate"]), st = Yf, Nf = ["center", "classes", "className"];
let Nn = (e) => e, Ma, Ya, Na, Ta;
const _n = 550, Tf = 80, Pf = to(Ma || (Ma = Nn`
  0% {
    transform: scale(0);
    opacity: 0.1;
  }
...
`), st.rippleVisible, Pf, _n, ({
  ...
  const n = bt({
    ...
    classes: i = {},
    className: s
  } = n, l = Ye(n, Nf), [c, u] = Y.useState([]), d = Y.useRef(0), f = Y.useRef(null);
  Y.useEffect(() => {
    f.current && (f.current(), f.current = null);
  }, [c]);
  const m = Y.useRef(!1), b = Y.useRef(0), A = Y.useRef(null), g = Y.useRef(null);
  Y.useEffect(() => () => {
  ...
  const v = Y.useCallback((C) => {
    ...
    u((N) => [...N, /* @__PURE__ */ h(jf, {
      ...
      rippleY: j,
      rippleSize: R
    }, d.current)]), d.current += 1, f.current = H;
  }, [i]), P = Y.useCallback((C = {}, D = {}, G = () => {
  }) => {
    const {
      pulsate: j = !1,
    ...
    const N = H ? null : g.current, I = N ? N.getBoundingClientRect() : {
      width: 0,
      height: 0,
      left: 0,
      top: 0
    ...
    if (R || C === void 0 || C.clientX === 0 && C.clientY === 0 || !C.clientX && !C.touches)
      ae = Math.round(I.width / 2), $ = Math.round(I.height / 2);
    else {
      const {
        clientX: se,
        clientY: re
      } = C.touches && C.touches.length > 0 ? C.touches[0] : C;
      ae = Math.round(se - I.left), $ = Math.round(re - I.top);
    }
    if (R)
      ne = Math.sqrt((2 * I.width ** 2 + I.height ** 2) / 3), ne % 2 === 0 && (ne += 1);
    else {
      const se = Math.max(Math.abs((N ? N.clientWidth : 0) - ae), ae) * 2 + 2, re = Math.max(Math.abs((N ? N.clientHeight : 0) - $), $) * 2 + 2;
...
const Rf = Se("MuiButtonBase", ["root", "disabled", "focusVisible"]), If = Rf, Vf = ["action", "centerRipple", "children", "className", "component", "disabled", "disableRipple", "disableTouchRipple", "focusRipple", "focusVisibleClassName", "LinkComponent", "onBlur", "onClick", "onContextMenu", "onDragLeave", "onFocus", "onFocusVisible", "onKeyDown", "onKeyUp", "onMouseDown", "onMouseLeave", "onMouseUp", "onTouchEnd", "onTouchMove", "onTouchStart", "tabIndex", "TouchRippleProps", "touchRippleRef", "type"], Hf = (e) => {
  ...
  const n = bt({
    ...
    touchRippleRef: ne,
    type: se
  } = n, re = Ye(n, Vf), ce = Y.useRef(null), le = Y.useRef(null), pe = Nt(le, ne), {
    isFocusVisibleRef: T,
    onFocus: L,
    onBlur: te,
    ref: Q
  } = ci(), [Z, _] = Y.useState(!1);
  u && Z && _(!1), Y.useImperativeHandle(o, () => ({
    focusVisible: () => {
  ...
  const ie = ee("start", G), fe = ee("stop", v), z = ee("stop", P), Ne = ee("stop", R), F = ee("stop", (J) => {
    Z && J.preventDefault(), j && j(J);
  }), S = ee("start", I), We = ee("stop", H), me = ee("stop", N), qe = ee("stop", (J) => {
    te(J), T.current === !1 && _(!1), A && A(J);
  }, !1), Re = Mt((J) => {
    ce.current || (ce.current = J.currentTarget), L(J), T.current === !0 && (_(!0), M && M(J)), W && W(J);
  }), Ie = () => {
    const J = ce.current;
    return c && c !== "button" && !(J.tagName === "A" && J.href);
  }, Le = Y.useRef(!1), Ve = Mt((J) => {
    m && !Le.current && Z && le.current && J.key === " " && (Le.current = !0, le.current.stop(J, () => {
      le.current.start(J);
    })), J.target === J.currentTarget && Ie() && J.key === " " && J.preventDefault(), C && C(J), J.target === J.currentTarget && Ie() && J.key === "Enter" && !u && (J.preventDefault(), g && g(J));
  }), ft = Mt((J) => {
    m && J.key === " " && le.current && Z && !J.defaultPrevented && (Le.current = !1, le.current.stop(J, () => {
      le.current.pulsate(J);
    })), D && D(J), g && J.target === J.currentTarget && Ie() && J.key === " " && !J.defaultPrevented && g(J);
  });
  let Qe = c;
...
const Xf = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Kf = (e) => {
  ...
  const n = bt({
    ...
    titleAccess: f,
    viewBox: m = "0 0 24 24"
  } = n, b = Ye(n, Xf), A = /* @__PURE__ */ Y.isValidElement(o) && o.type === "svg", g = x({}, n, {
    color: s,
    component: l,
    fontSize: c,
...
const Li = /* @__PURE__ */ Y.forwardRef(function(t, r) {
  ...
  } = n, D = Ye(n, tm), G = Y.useRef(null), j = Nt(G, r), R = (pe) => {
    pe.stopPropagation(), A && A(pe);
  }, H = (pe) => {
    pe.currentTarget === pe.target && Ba(pe) && pe.preventDefault(), g && g(pe);
  }, N = (pe) => {
    pe.currentTarget === pe.target && (A && Ba(pe) ? A(pe) : pe.key === "Escape" && G.current && G.current.blur()), v && v(pe);
  }, I = s !== !1 && b ? !0 : s, ae = I || A ? pn : c || "div", $ = x({}, n, {
    component: ae,
    disabled: d,
    size: P,
    color: l,
  ...
  })), process.env.NODE_ENV !== "production" && ce && le && console.error("MUI: The Chip component can not handle the avatar and the icon prop at the same time. Pick one."), /* @__PURE__ */ oe(nm, x({
    as: ae,
...
const mm = ["autoComplete", "autoHighlight", "autoSelect", "blurOnSelect", "ChipProps", "className", "clearIcon", "clearOnBlur", "clearOnEscape", "clearText", "closeText", "componentsProps", "defaultValue", "disableClearable", "disableCloseOnSelect", "disabled", "disabledItemsFocusable", "disableListWrap", "disablePortal", "filterOptions", "filterSelectedOptions", "forcePopupIcon", "freeSolo", "fullWidth", "getLimitTagsText", "getOptionDisabled", "getOptionLabel", "isOptionEqualToValue", "groupBy", "handleHomeEndKeys", "id", "includeInputInList", "inputValue", "limitTags", "ListboxComponent", "ListboxProps", "loading", "loadingText", "multiple", "noOptionsText", "onChange", "onClose", "onHighlightChange", "onInputChange", "onOpen", "open", "openOnFocus", "openText", "options", "PaperComponent", "PopperComponent", "popupIcon", "readOnly", "renderGroup", "renderInput", "renderOption", "renderTags", "selectOnFocus", "size", "slotProps", "value"], gm = ["ref"], hm = (e) => {
  ...
  const l = bt({
    ...
    ChipProps: m,
    className: b,
    clearIcon: A = Ga || (Ga = /* @__PURE__ */ h(um, {
      fontSize: "small"
    })),
    ...
    PopperComponent: ie = Gi,
    popupIcon: fe = ja || (ja = /* @__PURE__ */ h(dm, {})),
    readOnly: z = !1,
    renderGroup: Ne,
    renderInput: F,
    renderOption: S,
  ...
  })), tt = !D && !j && mt && !z, Ue = (!$ || ae === !0) && ae !== !1, {
    onMouseDown: ht
  } = Ve(), {
    ref: zt
  } = te ?? {}, Bt = Me(), {
    ref: qt
  } = Bt, kt = Ye(Bt, gm), fr = Nt(qt, zt), Et = re || ((O) => {
    var E;
  ...
  if (_ && J.length > 0) {
    ...
    We ? Je = We(J, O, He) : Je = J.map((E, q) => /* @__PURE__ */ h(am, x({
      label: Et(E),
      size: qe
    }, O({
      index: q
  ...
  if (T > -1 && Array.isArray(Je)) {
    const O = Je.length - T;
    !Xe && O > 0 && (Je = Je.splice(0, T), Je.push(/* @__PURE__ */ h("span", {
      className: je.tag,
      children: se(O)
    }, Je.length)));
  }
  const St = Ne || ((O) => /* @__PURE__ */ oe("li", {
    children: [/* @__PURE__ */ h(Mm, {
  ...
  }, O.key)), mr = S || ((O, E) => /* @__PURE__ */ h("li", x({}, O, {
    children: Et(E)
  }))), p = (O, E) => {
    const q = xe({
      option: O,
    ...
    children: [/* @__PURE__ */ h(bm, x({
      ...
      children: F({
        ...
        InputProps: x({
          ...
          endAdornment: /* @__PURE__ */ oe(vm, {
            className: je.endAdornment,
            ownerState: He,
            children: [tt ? /* @__PURE__ */ h(ym, x({}, Ze(), {
              "aria-label": P,
              title: P,
              ownerState: He
            }, B, {
      ...
      children: /* @__PURE__ */ oe(Am, x({
        ownerState: He,
        as: ee
      }, V, {
        className: Ae(je.paper, V == null ? void 0 : V.className),
        children: [Q && Ke.length === 0 ? /* @__PURE__ */ h(Om, {
          className: je.loading,
          ownerState: He,
          children: Z
        }) : null, Ke.length === 0 && !$ && !Q ? /* @__PURE__ */ h(xm, {
          ...
          children: X
        }) : null, Ke.length > 0 ? /* @__PURE__ */ h(Cm, x({
          as: L,
          className: je.listbox,
          ownerState: He
        }, kt, te, {
          ref: fr,
          children: Ke.map((O, E) => ce ? St({
            key: O.key,
            group: O.group,
...
const Nm = Fi, Tm = xi(), Pm = (e) => {
  const {
    ...
    multiple: l,
    ...c
  } = e, { control: u } = zr(), [d, f] = $e([]), [m, b] = $e(l ? [] : ""), [A, g] = $e(""), { isFetching: v, refetch: P, isFetched: W } = Qa({
    queryKey: ["options", A],
  ...
  const M = (j, R, H) => {
    ...
    b(R), H(R);
  }, C = (j) => typeof j == "string" ? j : j.inputValue ? j.inputValue : i ? i(j) : j.name, D = (j, R) => (
    // eslint-disable-next-line
    /* @__PURE__ */ is("li", { ...j, key: R.id ?? j.key }, i ? i(R) : R.name)
  ), G = (j, R) => {
    const H = Tm(j, R), N = String(R.inputValue).trim(), I = H.length === 0;
    return o && N !== "" && (I || !j.find((ae) => ae.name === N)) && H.push({
      inputValue: N,
      name: `Agregar "${N}"`
    }), !o && I && N !== "" && !v && W && H.push({
      inputValue: N,
  ...
  return /* @__PURE__ */ h(Wr, { fullWidth: !0, ...c, children: /* @__PURE__ */ h(
    Rr,
    {
      control: u,
      name: r,
      render: ({ field: { ref: j, onChange: R, ...H } }) => /* @__PURE__ */ h(
        Nm,
        {
          multiple: l,
          value: m,
          onChange: (N, I) => M(N, I, R),
          onKeyDown: (N) => g(N.target.value),
          filterOptions: G,
          options: d,
          selectOnFocus: !0,
          clearOnBlur: !0,
          ...
          renderInput: (N) => /* @__PURE__ */ h(
            Ha,
            {
              ...
              InputProps: {
                ...N.InputProps,
                endAdornment: /* @__PURE__ */ oe(ur, { children: [
                  v ? /* @__PURE__ */ h(Ia, { color: "inherit", size: 20 }) : null,
...
const Bm = (e, t) => {
  ...
  for (let n in t)
    if (!r[n] || r[n] === !1)
      return !1;
  return !0;
}, Em = ({ user: e, has: t, ...r }) => Bm(e, t) ? /* @__PURE__ */ h(vs, { ...r }) : null;
Em.propTypes = {
  has: a.object,
  user: a.object
};
...
var qi = No.default = void 0, Rm = zm(Zr()), Im = qr, Vm = (0, Rm.default)(/* @__PURE__ */ (0, Im.jsx)("path", {
...
const Fm = ki, Zm = ["children", "color", "component", "className", "disabled", "disableElevation", "disableFocusRipple", "endIcon", "focusVisibleClassName", "fullWidth", "size", "startIcon", "type", "variant"], qm = (e) => {
  ...
  return /* @__PURE__ */ oe(km, x({
    ownerState: D,
    className: Ae(n.className, G.root, u),
    component: c,
    disabled: d,
    focusRipple: !m,
    focusVisibleClassName: Ae(G.focusVisible, A),
    ref: r,
    type: W
  }, C, {
    classes: G,
...
var Qi = To.default = void 0, Xm = Qm(Zr()), Km = qr, Jm = (0, Xm.default)(/* @__PURE__ */ (0, Km.jsx)("path", {
...
const $m = ({ children: e, open: t, onClose: r, onAccept: n, onCancel: o }) => {
  ...
  return /* @__PURE__ */ h(
    Ee,
    {
      ...
      onClick: u,
      children: /* @__PURE__ */ h(ys, { in: t, direction: "right", children: /* @__PURE__ */ oe(
        fn,
        {
          ...
          children: [
            /* @__PURE__ */ oe(Ee, { direction: "row", alignItems: "center", mb: 1, children: [
              /* @__PURE__ */ h(Qi, { color: "primary" }),
              /* @__PURE__ */ h(ze, { variant: "h2", color: "primary", fontWeight: "bold", ml: 1, children: "Filtrar" })
            ] }),
            /* @__PURE__ */ h(
              rn,
              {
                ...
                children: /* @__PURE__ */ h(qi, {})
              }
            ),
            /* @__PURE__ */ h(Ee, { my: 2, children: e }),
            /* @__PURE__ */ oe(
              Ee,
              {
                direction: "row",
                ...
                children: [
                  ...
                  /* @__PURE__ */ h(za, { onClick: n, disabled: !t, children: "Aplicar" })
                ]
              }
            )
          ]
...
const Zg = ({
  ...
  sx: t,
  ...r
}) => /* @__PURE__ */ h(nn, { sx: { px: 1, py: 0.5, ...t }, ...r, children: e });
function qg() {
  const [e, t] = Xa();
  return {
...
const dg = (e) => {
  ...
  const n = bt({
    ...
    wrap: g = "wrap",
    zeroMinWidth: v = !1
  } = i, P = Ye(i, ng), W = b || A, M = c || A, C = Y.useContext(Ra), D = d ? l || 12 : C, G = {}, j = x({}, P);
  o.keys.forEach((N) => {
    P[N] != null && (G[N] = P[N], delete j[N]);
  });
  const R = x({}, i, {
    columns: D,
    container: d,
...
function kg() {
  return /* @__PURE__ */ h(La, { theme: ri, children: /* @__PURE__ */ oe(Fn, { container: !0, height: "100dvh", sx: {}, children: [
    /* @__PURE__ */ h(
      Fn,
      {
        item: !0,
    ...
    /* @__PURE__ */ oe(
      Fn,
      {
        ...
        position: "relative",
        children: [
          /* @__PURE__ */ h(Ee, { display: { xs: "flex", lg: "none" }, children: /* @__PURE__ */ h(
            "img",
            {
              src: "/login.webp",
              alt: "Gente haciendo ejercicio",
          ...
          /* @__PURE__ */ h(
            fn,
            {
              ...
              children: /* @__PURE__ */ h(Ka, {})
            }
          ),
          /* @__PURE__ */ h(mg, { sx: { position: "absolute", bottom: "0" } })
        ]
      }
    )
  ] }) });
...
const Ji = ({ children: e, onToggleDrawer: t, open: r }) => {
  ...
  return Gt(() => {
    r && o && t(!1);
  }, [n]), o ? /* @__PURE__ */ oe(_i, { open: r, onToggleDrawer: t, children: [
    /* @__PURE__ */ h(on, {}),
    e
  ] }) : /* @__PURE__ */ oe($i, { variant: "permanent", open: r, children: [
    /* @__PURE__ */ h(on, {}),
    e
  ] });
};
...
const _i = ({ onToggleDrawer: e, open: t, children: r }) => /* @__PURE__ */ h(
  Ua,
  {
    variant: "temporary",
    anchor: "left",
...
})), tn = ({ Icon: e, text: t, onClick: r }) => /* @__PURE__ */ oe(
  Cs,
  {
    sx: {
      width: "100%",
...
const ns = ({ user: e, logout: t, onToggleDrawer: r, open: n }) => {
  ...
  return /* @__PURE__ */ oe(ur, { children: [
            ...
            xs,
            {
              ...
              children: /* @__PURE__ */ h(
                Ee,
                {
                  ...
                  mt: 1,
                  width: "100%",
                  children: /* @__PURE__ */ oe(fn, { sx: { width: "100%" }, children: [
                    /* @__PURE__ */ oe(
                      Ee,
                      {
                        direction: "row",
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ oe(Ee, { direction: "column", children: [
                            /* @__PURE__ */ h(ze, { fontSize: 14, fontWeight: "bold", children: e == null ? void 0 : e.name }),
                            /* @__PURE__ */ h(ze, { fontSize: 12, children: (g = e == null ? void 0 : e.email) == null ? void 0 : g.toLowerCase() })
                          ] })
                        ]
                      }
                    ),
                    /* @__PURE__ */ oe(Ee, { direction: "column", justifyContent: "flex-start", children: [
                      /* @__PURE__ */ h(
                        tn,
                        {
                          Icon: es,
                    ...
                    /* @__PURE__ */ h(eo, { light: !0 }),
                    /* @__PURE__ */ h(Ee, { direction: "row", justifyContent: "flex-start", children: /* @__PURE__ */ h(
                      tn,
                      {
                        Icon: Ns,
                        text: "Cerrar sesión",
    ...
    /* @__PURE__ */ h(Yg, { position: "absolute", open: n, children: /* @__PURE__ */ oe(on, { sx: { position: "relative" }, children: [
      /* @__PURE__ */ h(
        rn,
        {
          edge: "start",
      ...
      ) : /* @__PURE__ */ h(ze, { children: window.tenant_data.name }),
      /* @__PURE__ */ oe(
        Ee,
        {
          display: { xs: "none", sm: "flex" },
          ...
          ref: i,
          children: [
            /* @__PURE__ */ h(rn, { sx: { mr: 1, color: "#fff" }, children: /* @__PURE__ */ h(rs, {}) }),
            /* @__PURE__ */ h(
              Un,
              {
...
function Ng({ ItemsList: e, logout: t, user: r }) {
  const [n, o] = $e(!1), i = () => o(!n);
  return /* @__PURE__ */ oe(an, { sx: { display: "flex" }, children: [
    /* @__PURE__ */ h(
      ns,
      {
        logout: t,
    ...
    /* @__PURE__ */ h(Ji, { open: n, onToggleDrawer: i, children: /* @__PURE__ */ h(e, {}) }),
    /* @__PURE__ */ oe(
      an,
      {
        component: "main",
        ...
        children: [
          ...
          /* @__PURE__ */ h(
            Ms,
            {
              ...
              children: /* @__PURE__ */ h(ss, { fallback: /* @__PURE__ */ h(Zt, {}), children: /* @__PURE__ */ h(Ka, {}) })
            }
          )
        ]
      }
